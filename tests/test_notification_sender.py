# -*- coding: utf-8 -*-
"""
Unit tests for src.notification_parts.senders module.
...
class TestDiscordSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.discord_sender.requests.post")
...
class TestWechatSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.wechat_sender.requests.post")
...
class TestFeishuSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.time.time", return_value=1700000000)
    @mock.patch("src.notification_parts.senders.feishu_sender.requests.post")
    ...
    def test_webhook_does_not_require_sdk_when_app_bot_is_also_configured(self, mock_webhook_post):
        ...
        with mock.patch("src.notification_parts.senders.feishu_sender.FEISHU_SDK_AVAILABLE", False), \
    ...
    def test_app_bot_missing_sdk_logs_constrained_requirements_install(self):
        ...
        with mock.patch("src.notification_parts.senders.feishu_sender.FEISHU_SDK_AVAILABLE", False), \
             self.assertLogs("src.notification_parts.senders.feishu_sender", level="WARNING") as logs:
            result = sender.send_to_feishu("hello")
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.uuid_mod.uuid4", return_value="uuid-open-id")
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.uuid_mod.uuid4")
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.time.sleep")
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.time.sleep")
    @mock.patch("src.notification_parts.senders.feishu_sender.CreateMessageRequest.builder", side_effect=RuntimeError("bad builder"))
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender.Path")
    ...
    @mock.patch("src.notification_parts.senders.feishu_sender._CreateFileRequestBody", create=True)
    @mock.patch("src.notification_parts.senders.feishu_sender._CreateFileRequest", create=True)
    @mock.patch("src.notification_parts.senders.feishu_sender.FEISHU_FILE_SDK_AVAILABLE", True)
    @mock.patch("src.notification_parts.senders.feishu_sender.Path")
    def test_send_feishu_file_app_bot_uploads_file_and_sends_message(self, *_):
        ...
        with mock.patch("src.notification_parts.senders.feishu_sender.Path", return_value=mock_path):
            cfg = _config(
                feishu_app_id="cli_app",
                feishu_app_secret="secret",
                feishu_chat_id="oc_chat",
...
class TestEmailSender(unittest.TestCase):
    ...
    def test_send_to_email_encodes_non_ascii_sender_name(self, mock_smtp_ssl):
        cfg = _config(
            ...
            email_sender_name="StockPulse 股票分析助手",
        )
        sender = EmailSender(cfg)
...
class TestNtfySender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.ntfy_sender.requests.post")
    ...
    def test_send_timeout_does_not_log_token_value(self, mock_post):
        ...
        with self.assertLogs("src.notification_parts.senders.ntfy_sender", level="ERROR") as captured:
            result = sender.send_to_ntfy("body")
...
class TestGotifySender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.gotify_sender.requests.post")
    ...
    def test_send_timeout_does_not_log_token_value(self, mock_post):
        ...
        with self.assertLogs("src.notification_parts.senders.gotify_sender", level="ERROR") as captured:
            result = sender.send_to_gotify("body")
...
class TestAstrbotSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.astrbot_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
        mock_post.return_value = _response(200)
...
class TestCustomWebhookSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.custom_webhook_sender.requests.post")
...
class TestPushoverSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.pushover_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
...
class TestPushplusSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.pushplus_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
...
class TestServerchan3Sender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.serverchan3_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
        mock_post.return_value = _response(200, {"code": 0})
...
class TestSlackSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.slack_sender.requests.post")
...
class TestTelegramSender(unittest.TestCase):
    ...
    @mock.patch("src.notification_parts.senders.telegram_sender.requests.post")
    def test_send_success_returns_true(self, mock_post):
        mock_post.return_value = _response(200, {"ok": True})
