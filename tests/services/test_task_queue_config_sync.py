...
_orig_data_provider_base = sys.modules.get("src.data_provider.base")
_orig_data_provider = sys.modules.get("src.data_provider")

if _orig_data_provider_base is None:
    base_mod = types.ModuleType("src.data_provider.base")
    ...
    sys.modules["src.data_provider.base"] = base_mod

if _orig_data_provider is None:
    pkg_mod = types.ModuleType("src.data_provider")
    pkg_mod.__path__ = []
...
if _orig_data_provider_base is None:
    ...
    sys.modules["src.data_provider.base"] = _orig_data_provider_base

if _orig_data_provider is None:
    sys.modules.pop("src.data_provider", None)
else:
    sys.modules["src.data_provider"] = _orig_data_provider
