...
def test_reply_client_uses_lark_domain_from_environment(monkeypatch):
    ...
    config = mock.Mock(spec=["feishu_max_bytes"])
...
def test_stream_and_reply_clients_share_lark_domain(monkeypatch):
    config = mock.Mock(
