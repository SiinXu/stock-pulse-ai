...
> [!NOTE]
> **StockPulse** 基于开源项目 [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis)(MIT License)二次开发与定制,在此向原作者致谢。原始版权与授权条款见 [LICENSE](LICENSE)。
