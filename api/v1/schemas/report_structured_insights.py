...
"""Typed API projection for structured report insights.
...
their bounded, renderer-safe fields as a product-layer transport contract so
synchronous, task, and history reports share one additive projection.
Historical or malformed payloads remain valid when the projection is absent.
"""
