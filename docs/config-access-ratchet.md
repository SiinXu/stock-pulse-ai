...
| `src/api/v1/endpoints/system_config.py` (`get_kronos_status`) | Composition-root config for status probe (converted when landing after main introduced the site) |
