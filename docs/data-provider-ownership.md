...
| Public path | Role |
| --- | --- |
| `src.data_provider.base` | Canonical facade and current home of manager/fetcher workflows still mixed in, re-exports of extracted pure helpers/errors/chip helpers, and rebound capability-catalog / health / daily-cache / daily-execution / realtime field-trust / realtime quote orchestration / money-flow cache / money-flow orchestration / fundamental cache / fundamental loaders / belong-board descriptors. |
...
## Ownership Map (after fundamental loader extraction)
