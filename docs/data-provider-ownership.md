...
`prefetch_realtime_quotes`, `_SUPPLEMENT_FIELDS`, chip, and stock-name
stay on the facade. Rankings travel with Slice 13. `get_realtime_quote` is rebound
...
Slice 13 rebinds rankings orchestration descriptors from
