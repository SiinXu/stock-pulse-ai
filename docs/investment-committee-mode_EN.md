...
- **Report / History**: `ReportStructuredInsights` renders committee conclusion, member stances, reserved opinions, and divergence when the payload is present. Member stances, reserved opinions, and divergence lists start behind collapsed sections; after expanding, they show the first 3 items, with Show all / Show less for the rest. The committee conclusion stays open.
