...
| `INFO_QUALITY_GRADING_ENABLED` | 基于校验层与上下文包状态推导 A/B/C 信息质量等级，供报告与结论约束使用。 | `true` | 可选 |
| `FORCED_CONCLUSION_ENABLED` | 要求报告与 DecisionSignal 附带 Pass/Fail/Watch 强制结论；等级 C 禁止无证据 Pass。 | `true` | 可选 |
