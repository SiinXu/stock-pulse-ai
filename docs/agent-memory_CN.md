...
- 记忆 provenance、事实/意见隔离与防投毒基线：[#1124](https://github.com/SiinXu/stock-pulse-ai/issues/1124)。DAG-1（本锁定与测试）已落地。剩余：DAG-2 Soul/超限拒绝；DAG-3 服务端盖章 provenance。不要并入 #1118 存储/UI、#1119 遗忘策略或 #1105 产品反馈 API。
