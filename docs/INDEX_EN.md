...
| [Agent Router Rules Library](agent-router_EN.md) | Rules-first AgentRouter plus structured fact projection; dashboard `AgentOrchestrator.run()` applies the router once per run and restores constructor mode (#1120 slices 1–3; Chat/factory remain not wired; [Chinese](agent-router.md)) |
