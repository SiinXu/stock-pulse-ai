...
| [Web UI Foundation Contract](web-ui-foundation.md) | Semantic controls, visible sizes, coarse-pointer targets, surface-role/density D5 ratchet (#877), native-button adoption ratchet (#878), guardrails, and migration ownership |
