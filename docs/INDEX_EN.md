...
| **Confirm security boundaries before a public or non-local bind** | [Security baseline — operator boundaries](security-baseline.md#operator-security-boundaries-deployers) | [Deploy Guide (EN)](DEPLOY_EN.md), [Outbound HTTP Policy](security-outbound-policy.md) |
| Understand the plugin trust model (not a marketplace sandbox) | [Plugin extension contract](plugin-extension-contract.md) | [Security baseline — operator boundaries](security-baseline.md#operator-security-boundaries-deployers) |
...
| [Personal Investment Framework Backend Contract](personal-investment-framework_EN.md) | Strict local-account content, immutable version history, CRUD APIs, deactivate/delete behavior, optimistic locking, the context-read boundary, migration, and rollback |
