...
| [Community Intelligence Agent Tool Contract](community-intel-tool.md) | Phase A stock-scoped ToolSurface input/output, degradation, security boundaries, limitations, and rollback |
