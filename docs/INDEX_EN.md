...
| [Agent Router Rules Library](agent-router_EN.md) | Rules-first AgentRouter for quick/standard/full/specialist and Chat incremental_tool vs full_repipeline; valid override wins, invalid override fail-closed (#1120 slice 1, not wired to production callers; [Chinese](agent-router.md)) |
