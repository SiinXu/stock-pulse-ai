...
**Phase 2 unused-wrapper deletion — Home loading-ring (#1300).** Unused `--home-loading-ring-track` and `--home-loading-ring-head` are deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 43 → 41; `TOKEN_FORMAT_DEBT` stays 12 because neither name was on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions stay strictly `> 160`: the defined inventory is 161 after deleting these two names. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. `--home-divider-border` and remaining live `--home-*` families are out of this slice.

**Phase 2 unused-wrapper deletion — Home divider (#1300).** Unused `--home-divider-border` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 41 → 40; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 160` to `> 159`: the defined inventory is 160 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (panel, surface, hero, price) are out of this slice.

**Phase 2 unused-wrapper deletion — Home state-icon (#1300).** Unused `--home-state-icon-muted` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 40 → 39; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 159` to `> 158`: the defined inventory is 159 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (panel, surface, hero, price) are out of this slice.

**Phase 2 unused-wrapper deletion — Home secondary-accent (#1300).** Unused `--home-secondary-accent-text` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 39 → 38; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 158` to `> 157`: the defined inventory is 158 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, hero, price) are out of this slice.

**Phase 2 unused-wrapper deletion — Home accent-bg-hover (#1300).** Unused `--home-accent-bg-hover` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 38 → 37; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 157` to `> 156`: the defined inventory is 157 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, hero, price) and unused `--home-accent-border-hover` are out of this slice.

**Phase 2 unused-wrapper deletion — Home accent-border-hover (#1300).** Unused `--home-accent-border-hover` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 37 → 36; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 156` to `> 155`: the defined inventory is 156 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, hero, price) and unused hero/history/panel/rail leftovers are out of this slice.

**Phase 2 unused-wrapper deletion — Home hero-border (#1300).** Unused `--home-hero-border` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 36 → 35; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 155` to `> 154`: the defined inventory is 155 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused hero-gradient / history / panel / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home hero-gradient-start (#1300).** Unused `--home-hero-gradient-start` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 35 → 34; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 154` to `> 153`: the defined inventory is 154 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-gradient-mid` / `--home-hero-gradient-end` / history / panel / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home hero-gradient-mid (#1300).** Unused `--home-hero-gradient-mid` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 34 → 33; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 153` to `> 152`: the defined inventory is 153 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-gradient-end` / `--home-hero-shadow` / history / panel / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home hero-gradient-end (#1300).** Unused `--home-hero-gradient-end` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 33 → 32; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 152` to `> 151`: the defined inventory is 152 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / history / panel / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home panel-border-selected (#1300).** Unused `--home-panel-border-selected` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 32 → 31; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 151` to `> 150`: the defined inventory is 151 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / panel-gradient / history / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home panel-gradient-start (#1300).** Unused `--home-panel-gradient-start` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 31 → 30; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 150` to `> 149`: the defined inventory is 150 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / `--home-panel-gradient-mid` / `--home-panel-gradient-end` / history / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home panel-gradient-mid (#1300).** Unused `--home-panel-gradient-mid` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 30 → 29; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 149` to `> 148`: the defined inventory is 149 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / `--home-panel-gradient-end` / history / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home panel-gradient-end (#1300).** Unused `--home-panel-gradient-end` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 29 → 28; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 148` to `> 147`: the defined inventory is 148 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / `--home-history-item-bg` / history hover/selected / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family.

**Phase 2 unused-wrapper deletion — Home history-item-bg (#1300).** Unused `--home-history-item-bg` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 28 → 27; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 147` to `> 146`: the defined inventory is 147 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price) and the live `.home-report-hero` class, plus unused `--home-hero-shadow` / `--home-history-item-hover-bg` / `--home-history-item-selected-bg` / rail leftovers, are out of this slice. `.home-report-hero` is a live class; the remaining `--home-hero-*` custom properties remain unused leftovers and are not a live token family. A later landed slice deletes `--home-rail-border`; it does not delete `--home-rail-bg`, `--home-rail-shadow`, `--home-hero-shadow`, or history hover/selected.

**Phase 2 unused-wrapper deletion — Home rail-border (#1300).** Unused `--home-rail-border` is deleted from `:root` and `.dark`. There is no production or test consumer and no replacement page or domain token. `THEME_PAGE_SCOPED_TOKEN_CEILING` moved 27 → 26; `TOKEN_FORMAT_DEBT` stays 12 because this name was not on that list. The `themeContractGuard` / `themeTokenFreezeGuard` non-vacuity assertions move from strictly `> 146` to `> 145`: the defined inventory is 146 after deleting this name. Rendered light/dark computed styles and theme-pack behaviour are unchanged because the deleted declarations had no consumer. Layer 0 price paint and `--home-price-up/down` aliases are unchanged. Remaining live `--home-*` families (accent chip, panel, surface, price), the live `.home-report-hero` class, live `--home-rail-bg` on `.home-rail-card`, plus unused `--home-hero-shadow` / `--home-rail-shadow` / `--home-history-item-hover-bg` / `--home-history-item-selected-bg`, are out of this slice. `.home-rail-card` is a live class that reads `--home-rail-bg` only; `--home-rail-border` is not a live token family.
