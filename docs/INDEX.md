...
| **了解 StockPulse 相对上游的差异** | [README · 为什么选择 StockPulse](../README.md#为什么选择-stockpulse相对上游) | [英文 README · Why StockPulse](README_EN.md#why-stockpulse-vs-upstream)、[技术架构总览](architecture-overview.md) |
| 第一次把项目跑起来 | [小白客户端安装与配置](beginner-client-setup.md)（[English](beginner-client-setup_EN.md)） | [README · 差异说明](../README.md#为什么选择-stockpulse相对上游)、[安全基线 · 运维边界](security-baseline.md#operator-security-boundaries)、[完整配置与部署指南](full-guide.md) |
...
| [个人投资框架后端合同](personal-investment-framework.md) | 单机账户的严格内容 schema、不可变版本历史、CRUD/API、停用/删除、乐观锁、上下文读取边界与迁移回滚 |
