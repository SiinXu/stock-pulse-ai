...
| 第一次把项目跑起来 | [小白客户端安装与配置](beginner-client-setup.md)（[English](beginner-client-setup_EN.md)） | [完整配置与部署指南](full-guide.md) |
| **学习 Web / 桌面界面怎么用** | [界面操作手册](ui-manual/README.md) | 各模块分册（含发现 / 选股、分析、信号、持仓等） |
