...
| [Agent 深度路由规则库](agent-router.md) | 纯规则 AgentRouter：quick/standard/full/specialist 与 Chat incremental_tool/full_repipeline；合法覆盖优先、非法覆盖失败关闭（#1120 第一切片，未接线生产调用方；[英文](agent-router_EN.md)） |
