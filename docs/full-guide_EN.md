...
- **Research overview** - `/research` is the dedicated hub for Market Review, Discover, Analysis Workbench, and Backtest; Market Review remains at `/research/market`. In expanded desktop navigation and the mobile drawer, the full Research row expands or collapses its children and the first child, Research overview, opens `/research`. In the compact rail, Research remains a menu trigger and Research overview is likewise the first flyout item.
