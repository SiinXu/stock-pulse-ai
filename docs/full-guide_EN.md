...
- **Research overview** - `/research` is the dedicated hub for Market Review, Discover, Analysis Workbench, and Backtest; Market Review remains at `/research/market`. In expanded desktop navigation and the mobile drawer, the Research label opens the overview while a separately labelled chevron expands or collapses its children. In the compact rail, Research remains a menu trigger and Research overview is the first flyout item.
