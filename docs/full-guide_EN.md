...
- **Quick Analysis** - When required setup is incomplete and no explicit preference exists, Home defaults to Beginner mode and requests a `brief` report. Configured users keep the Professional default and `detailed` reports.
