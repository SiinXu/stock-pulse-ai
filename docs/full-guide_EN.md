...
| `INFO_QUALITY_GRADING_ENABLED` | Derive A/B/C information quality grades from validation evidence and context-pack block statuses. | `true` | Optional |
| `FORCED_CONCLUSION_ENABLED` | Require Pass/Fail/Watch forced conclusions; grade C blocks evidence-free Pass. | `true` | Optional |
