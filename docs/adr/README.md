...
| [ADR-012](ADR-012-installable-package-layout.md) | Accepted | Four existing import roots become installable packages via `pip install -e . --no-deps`; no import rewrite | Issue #167; implementation PR introducing `[tool.setuptools.packages.find]` |
