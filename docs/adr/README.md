...
| [ADR-005](ADR-005-provider-fallback-and-circuit-control.md) | Accepted (retrospective) | Priority-based provider fallback with market-scoped health and circuit control | [PR #290](https://github.com/SiinXu/stock-pulse-ai/pull/290) |
...
| [ADR-007](ADR-007-versioned-plugin-extension-boundary.md) | Proposed | Versioned plugin lifecycle and six policy-preserving extension points | [Issue #274](https://github.com/SiinXu/stock-pulse-ai/issues/274) |
