...
- Memory provenance, fact/opinion isolation, and anti-poisoning baseline: [#1124](https://github.com/SiinXu/stock-pulse-ai/issues/1124). DAG-1 (fact/opinion lock) and DAG-2 (Soul/oversize write reject in `src/schemas/memory_write_guard.py`) have landed. Remaining: DAG-3 server-stamped provenance. Do not fold in #1118 store/UX, #1119 forgetting, or #1105 product feedback APIs.
