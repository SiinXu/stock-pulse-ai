...
- [Added] Analysis Workbench launch/batch failures adopt the shared API error contract: inline actionable alerts with CTAs, collapsible technical codes, and busy-state submit blocking (#885 Phase 2).
