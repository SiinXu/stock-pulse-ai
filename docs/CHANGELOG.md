...
- [Added] Wired trusted notification channel plugins into the existing route, noise-control, image-preparation, and attempt-aggregation path with fail-closed IDs, isolated diagnostics, lifecycle cleanup, and a deterministic log-sink example.
