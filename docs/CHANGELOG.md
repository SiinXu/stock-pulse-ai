...
- [Fixed] Hardened local model lifecycle mutations with bounded Ollama response streaming and absolute pull deadlines, serialized and runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, single-use registration recovery revoked after successful deletion, and explicit memory-tier labels.
- [Fixed] Hardened local model lifecycle mutations with bounded Ollama response streaming and absolute pull deadlines, canonical opaque runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, deletion-reserved single-use registration recovery that cannot restore missing weights, and explicit memory-tier labels.
- [Fixed] Hardened local model lifecycle mutations with bounded Ollama response streaming and absolute pull deadlines, canonical opaque runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, catalog-only registration, deletion-reserved exact-version offline recovery, best-effort idempotent finalization, and explicit memory-tier labels.
- [Fixed] Hardened local model lifecycle mutations with bounded Ollama response streaming and absolute pull deadlines, canonical opaque runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, deletion-reserved single-use registration recovery that cannot restore missing weights, and explicit memory-tier labels.
- [Fixed] Hardened local model lifecycle mutations with bounded Ollama response streaming and absolute pull deadlines, canonical opaque runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, catalog-only registration, deletion-reserved exact-version offline recovery, best-effort idempotent finalization, and explicit memory-tier labels.
- [Fixed] Hardened local model lifecycle mutations with canonical cancellable pull tasks, bounded Ollama response streaming and absolute deadlines, opaque runtime-snapshot-bound Desktop operations, complete task-reference deletion checks, catalog-only registration, exact-version offline deletion reservations for registered and unregistered models, best-effort idempotent finalization, and explicit memory-tier labels.
