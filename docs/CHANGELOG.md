...
## [Unreleased]
- [Fixed] Enforce the OpenBB demonstration adapter SDK wall-clock deadline and route typed provider timeouts through the existing data-source fallback chain.
