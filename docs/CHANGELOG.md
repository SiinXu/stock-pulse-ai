...
- [Changed] Slimmed Web Home into a source-aware three-block attention hub, moved report and Run Flow ownership plus confirmed history deletion to Analysis Workbench, and retained canonical redirects for legacy Home analysis links.
