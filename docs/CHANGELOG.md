...
## [Unreleased]
- [Added] Unified API error taxonomy (category, severity, default action) integrated with existing stable `error` codes; Web remediation renders retry/settings/docs CTAs with operation-owned Retry only; guard requires new stable catalog codes to be classified (Refs #186, #1064, #232, #885).
