...
- [Added] Structured multi-agent disagreement handling with dual-layer cross-validation and split-verdict escalation behind `AGENT_DISAGREEMENT_HANDLING`; high disagreement is forced to a conservative hold and annotated on final products (Refs #246, #193).
