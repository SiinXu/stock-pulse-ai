...
- [Added] Report version comparison view with version picker API, side-by-side field diffs, configuration fingerprint differences, graded severity coloring, and T17 compare_analyses adapter (#188 / T18).
