...
- [Added] Read-only Agent capability registry aggregation view and GET /api/v1/capabilities endpoint projecting data-provider, tool, and plugin-extension readiness with honest unavailable reasons (feature_disabled / missing_config / missing_dependency) without changing the three existing registries (#221).
