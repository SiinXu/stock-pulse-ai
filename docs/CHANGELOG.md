...
- [Changed] Migrate Agent Web Search tools (`search_stock_news`, `search_comprehensive_intel`) to the always-on `builtin.web_search` agent_tool plugin following the OCR registration paradigm; ToolSurface call path and default availability unchanged (Refs #432).
