...
- [Added] Financial calculators for compound growth and goal planning (required contribution / time-to-goal) with pure backend math, `/api/v1/calculators/*` endpoints, and a Web tools page that rejects non-finite inputs and reports unreachable targets explicitly (#240).
