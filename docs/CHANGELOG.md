...
## [Unreleased]
- [Added] Notification inbox projects durable daily-brief, high-disagreement, and portfolio-health occurrences from authoritative stored sources without fabricating ephemeral rows (Refs #181).
