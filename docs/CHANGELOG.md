...
- [Changed] Slimmed Web Home into a three-block attention hub, moved report and Run Flow ownership to Analysis Workbench, and retained canonical redirects for legacy Home analysis links.
