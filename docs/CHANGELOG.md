...
- [Added] SmartMoney money-flow tracking: additive `money_flow` data-provider capability, AkShare A-share individual fund-flow normalization with bucket calibration metadata, `SMARTMONEY_ENABLED` (default off), and optional analysis-context injection (#862).
