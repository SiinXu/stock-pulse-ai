...
- [Added] Unified financial data validation layer at DataFetcherManager exits (OHLCV / realtime quote / fundamentals) with structured reason codes, warn-only default, and opt-in DATA_VALIDATION_STRICT (#185).
