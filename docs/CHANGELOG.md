...
- [Added] Peer relative-value canvas: explainable custom/industry peer sets (caller-asserted membership), not_applicable vs missing metric cells, cross-market estimate currency normalization with cached FX conversion, Stock Details UI reusing valuation service + visualization-only heatmap, and relative-claim policy library/tests (Refs #1139, #1127).
