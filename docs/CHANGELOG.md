...
- [Added] Settings Model Sources hub unifies cloud, local model server, and local CLI with a route-backed setup flow (add → test → enable → assign) and honest availability badges (Refs #865).
