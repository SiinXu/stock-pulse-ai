...
- [Added] Layered agent memory (episodic + semantic) with structured retrieval by default and optional pure-Python vector re-ranking via `AGENT_MEMORY_VECTOR_ENABLED` (no faiss/chroma); master switch remains `AGENT_MEMORY_ENABLED`.
