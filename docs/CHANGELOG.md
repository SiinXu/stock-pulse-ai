...
- [Fixed] Clarify Discover/screening empty and degraded states: never-run guide, no-hits vs full data-source failure, single capability banner, and Settings data-sources CTA (#871).
