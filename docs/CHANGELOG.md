...
- [Changed] Unified Settings Model Sources hub: cloud channels, local models, and local CLI status in one searchable view; multi-step connection setup uses an in-page wizard instead of a long modal (#865 / #877).
