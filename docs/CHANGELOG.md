...
- [Added] Data Sources hub cards show role (default/enhancer/advanced), capability, config-derived status, search filters, and stable deep-link anchors without inventing runtime health (#867).
