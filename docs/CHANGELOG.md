...
## [Unreleased]
- [Added] Added five opt-in investment committee Persona Skills with bounded built-in discovery, explicit existing-tool lists, differentiated evidence and risk lenses, and mandatory research-only, non-affiliation, and investment-risk disclosures.
