...
## [Unreleased]
- [Added] High-risk i18n native-review pipeline: annotated key inventory, review-pass evidence, and explicit PENDING_NATIVE_REVIEW markers without blocking CI or growing the identical-to-English baseline (Refs #882).
