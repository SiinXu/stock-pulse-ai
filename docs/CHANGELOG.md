...
- [Added] Peer relative-value canvas: explainable custom/industry peer sets, missing-data annotation, cross-market estimate currency normalization, Stock Details UI reusing valuation service + chart heatmap, and relative-claim policy tests (Refs #1139, #1127).
