...
- [Chore] Rebaseline Web locale/panel gzip budgets after PREDICTION_EXTRACT_ENABLED Settings help inventory keys (Refs #1108).
...
- [Added] PredictionExtractor maps structured decision/dashboard fields to PredictionRecord drafts behind PREDICTION_EXTRACT_ENABLED; prose never becomes a fake verifiable claim (Refs #1108, #1107).
- [Fixed] Prediction extraction preserves structured-output provenance, rejects normalized Agent/analysis defaults, and fails closed on partially invalid claim sets (Refs #1108, #1107).
