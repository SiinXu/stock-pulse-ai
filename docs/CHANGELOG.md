...
- [Added] Single config resolve path returns value + source (`default` / `env` / `persisted`) via `src.core.config`, with Config facades and comparison tests that freeze pre-#1070 effective values (Refs #1070).
