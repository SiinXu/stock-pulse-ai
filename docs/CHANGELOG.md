...
## [Unreleased]
- [Added] Added a versioned local personal investment framework backend with strict structured content, optimistic concurrency, CRUD/history APIs, explicit deactivate/delete semantics, and a read-only analysis-context adapter.
