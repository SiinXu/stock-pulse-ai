...
## [Unreleased]
- [Changed] Unify Decision Signals selection on `selectedSignalId` with a fixed Context Chip for symbol, source, and status; list, latest, and timeline remain display entry points only (Refs #1332).
