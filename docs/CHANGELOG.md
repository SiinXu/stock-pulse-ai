...
- [Added] Watchlist groups with drag-and-drop reordering, multi-group membership, mobile Move-to actions, default-group migration from STOCK_LIST, and per-member attrs mount for scoring/focus (#189).
