...
- [Added] Report three modes (brief/standard/research) with hard length limits, Decision Card assembly, and explicit truncation notices for Jinja reports (#861 Phase 2).
