...
- [Added] Explicit proposal-only Agent planning foundation with strict schema/tool validation, finite bounds, cancellation fencing, sanitized metadata, and no production runtime hook (refs #199).
