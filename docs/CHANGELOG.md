...
- [Added] Added A-share sector-index analysis with session trend, broad-index relative strength, risk labels, and explicit provider data limits to market-review reports and structured payloads.
