...
## [Unreleased]
- [Added] Added a versioned Agent Soul charter with one fail-closed composer across Native Single, Multi, and Chat prompts plus traceable version/hash run metadata.
