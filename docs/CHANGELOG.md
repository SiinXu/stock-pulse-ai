...
## [Unreleased]
- [Added] Added the Phase A stock-scoped community intelligence ToolSurface contract with strict bounded evidence, deterministic provider fixtures, explicit degradation, and no default runtime registration.
