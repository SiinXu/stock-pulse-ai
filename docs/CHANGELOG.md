...
## [Unreleased]
- [Added] Portfolio import wizard accepts CSV/XLSX spreadsheets, returns structured failed rows with rejection reasons, and supports downloading failed rows for correction (Refs #161).
