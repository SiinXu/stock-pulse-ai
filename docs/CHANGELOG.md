...
## [Unreleased]
- [Added] Default-off A-share specialist Skills for policy/catalyst, capital flow, and microstructure rules, with explicit data-dependency degradation and existing specialist report path (Refs #192).
