...
- [Added] Prediction `resolve_after` policy computes UTC due times from per-market exchange sessions (CN/HK/US holidays, half-days, timezones) without natural-day approximation (Refs #1109, #1107).
