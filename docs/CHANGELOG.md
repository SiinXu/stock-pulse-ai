...
- [Added] Added a dedicated Web Research overview at `/research`; expanded desktop and mobile Research parent rows navigate to the overview while a trailing control discloses the existing Research tools, and the compact menu exposes the overview before those tools.
...
- [Docs] Cross-link onboarding differentiators and security boundaries in documentation indexes.
...
- [Added] Wired trusted plugin event hooks to six observational stock-analysis and market-review lifecycle events with sanitized immutable payloads, deterministic ordering, unload cleanup, and callback failure isolation.
...
- [Fixed] Hardened the default-off Phase A community-intelligence contract with deterministic public-reference namespaces, full nested evidence revalidation, bounded prompt output, ToolSurface-consistent Hong Kong identities, and visible citation redaction gaps.
- [Fixed] Hardened the default-off Phase A community-intelligence contract with offline Public Suffix List reference validation, explicit special-use exclusions, full nested evidence revalidation, bounded prompt output, ToolSurface-consistent Hong Kong identities, and visible citation redaction gaps.
