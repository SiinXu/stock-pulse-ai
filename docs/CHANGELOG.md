...
## [Unreleased]
- [Added] First-class news/event sentiment evidence pipeline (`sentiment-snapshot-v1`) with source traceability, freshness, confidence, explicit degradation, and AnalysisContextPack `sentiment` evidence block (Refs #179).
