...
- [Added] Paper-trading decision process-quality scores (analysis support, risk-gate compliance, position discipline) with explainable reasons and a portfolio API; process-only and not a PnL evaluation (Refs #1134, #1127, #987).
