...
## [Unreleased]
- [Changed] Defined Pydantic v2 request, response, service-boundary, and OpenAPI contracts for the complete AlphaSift API route group while preserving existing wire fields and adapter extensions.
