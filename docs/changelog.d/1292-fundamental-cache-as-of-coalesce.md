...
- [Fixed] Resolve fundamental cache TTL and max entries through injected Config or DataFetcherManager._get_fundamental_config rather than a new-module get_config().
