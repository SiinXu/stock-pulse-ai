...
| 区域 | 常见位置 | 作用 | 小白怎么记 |
| --- | --- | --- | --- |
| **主导航** | 宽屏在左侧；手机 / 窄屏常在顶部或抽屉 | 首页、研究、信号、持仓、设置等 | 「目录」 |
| **主内容区** | 中央大块 | 当前功能页 | 「正文」 |
| **通知铃** | 顶栏或侧栏上方 | 最新**信号**与**告警**入口 | 「有没有新消息」 |
...
| 导航名（以界面为准） | 大致包含 | 对应手册 |
| --- | --- | --- |
| 首页 | 注意力摘要、待办 | [02 首页](02-home.md) |
| 研究 | 分析工作台、大盘复盘等 | [03](03-analysis-workbench.md)、[04](04-market-review.md) |
| 问股 / Agent | 多轮对话 | [05 问股对话](05-agent-chat.md) |
| 信号 | 建议池、规则、推送历史 | [06 信号中心](06-signals.md) |
| 持仓 | 账户与风险 | [07 持仓](07-portfolio.md) |
| 设置 | 模型、自选、通知等 | [10 设置](10-settings.md) |

文案可能随版本微调；以你屏幕上的标签为准，本手册会跟进更新。
