...
| Agent 行为 · 投资框架 | 维护研究时只读注入的个人框架；编辑器直接显示在该横向标签页，历史版本从页面内抽屉查看并可复制到当前草稿 |
...
| **个人投资框架** | **已合入结构化 Web 编辑器与历史** | 设置 → **Agent 行为 → 投资框架**；编辑器直接显示在独立横向标签页，历史版本使用页面内只读抽屉 | 支持决策树、评估维度、不可变历史只读查看/复制到草稿、版本化保存、停用和删除；字段边界见 `docs/personal-investment-framework.md` |
