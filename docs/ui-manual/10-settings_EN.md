...
| **Personal investment framework** | **Minimal Web editor shipped** | Settings → **Agent behavior**; the page shows compact status and **View fields** opens the configuration dialog | Supports create, versioned save, deactivate, and delete; see `docs/personal-investment-framework.md` for field boundaries |
