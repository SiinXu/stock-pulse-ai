...
- `tests/test_multi_agent.py`、`tests/reports/test_report_language.py`、`tests/test_notification.py`、`tests/test_analysis_history.py`、`tests/reports/test_report_renderer.py`：反例矩阵，从 SkillAgent 输入 → StrategyEngine 分拣/聚合 → DecisionAgent prompt → dashboard payload → renderer 实际文本全链路断言。
...
| 反例矩阵 | `tests/test_multi_agent.py`, `tests/reports/test_report_language.py`, `tests/test_notification.py`, `tests/test_analysis_history.py`, `tests/reports/test_report_renderer.py` |
