...
| `AGENT_ERROR_PATTERN_INJECT_TOP_K` | `3` | yes | commented template; Max pattern cards injected |
| `AGENT_ERROR_PATTERN_INJECT_CHAR_BUDGET` | `2000` | yes | commented template; Checklist character budget |
