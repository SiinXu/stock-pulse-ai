...
| `MULTI_MODEL_CONSENSUS_MAX_COST_USD` | empty | yes | commented template; USD budget: empty=MAX_MODELS only; 0=close fan-out; positive=hard-cap 2 models (no live pricing yet) |
