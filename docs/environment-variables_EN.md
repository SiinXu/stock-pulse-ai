...
- **Registered** is whether the key appears in `get_registered_field_keys()`; `no` marks a registry gap (tracked in [#1026](https://github.com/SiinXu/stock-pulse-ai/issues/1026); do not edit registry parts in a docs-only PR).
