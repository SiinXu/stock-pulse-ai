...
| `PREDICTION_RESOLVE_ENABLED` | `false` | yes | commented template; Prediction horizon resolver master switch (Issues #1102 / #1116; default off) |
| `PREDICTION_RESOLVE_INTERVAL_SECONDS` | `60` | yes | commented template; Seconds between PredictionResolver.tick runs |
| `PREDICTION_RESOLVE_LEASE_SECONDS` | `120` | yes | commented template; Resolving lease TTL seconds |
| `PREDICTION_RESOLVE_MAX_ATTEMPTS` | `5` | yes | commented template; Hard attempt ceiling for data-unavailable resolution |
| `PREDICTION_RESOLVE_MAX_PER_TICK` | `50` | yes | commented template; Max due predictions claimed per tick |
