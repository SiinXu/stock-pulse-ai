...
| `ADMIN_SESSION_MAX_AGE_HOURS` | `24` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_DECISION_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_GENERATION_BACKEND` | `auto` | yes | Ask-stock Agent backend: `auto`, `litellm`, `codex_cli`, `claude_code_cli`, or `opencode_cli`; local CLI uses the controlled tool bridge |
| `AGENT_INTEL_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_MAX_IDENTICAL_TOOL_CALLS` | `3` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `AGENT_MAX_STAGE_ENTRIES` | `1` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_PORTFOLIO_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `AGENT_RISK_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_SKILL_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `AGENT_STAGE_FAILURE_POLICY` | `isolate` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `AGENT_TECHNICAL_AGENT_TIMEOUT_S` | `0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `AGENT_TOOL_TIMEOUT_S` | `120` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `COINGECKO_API_BASE` | `empty` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `COINGECKO_API_KEY` | `empty` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `COINGECKO_API_PLAN` | `keyless` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `CRYPTO_COINGECKO_PRIORITY` | `10` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `CRYPTO_PROVIDER_ENABLED` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `DAILY_BRIEF_NOTIFY` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DAILY_BRIEF_PERSIST_HISTORY` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DAILY_BRIEF_SAVE_REPORT_FILE` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `DATA_VALIDATION_ENABLED` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DATA_VALIDATION_INSTRUMENT_OVERRIDES` | `empty` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DATA_VALIDATION_STRICT` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DATA_VALIDATION_STRICT_SCOPES` | `*/*` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DATA_VALIDATION_UPPER_LAYER_MODE` | `warn` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DEBUG` | `false` | yes | Enable debugging logs |
| `DECISION_MEMORY_ENABLED` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DECISION_MEMORY_LOOKBACK` | `5` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DECISION_MEMORY_MIN_AGE_DAYS` | `3` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `DECISION_MEMORY_MIN_SAMPLES` | `5` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `ENABLE_FUNDAMENTAL_PIPELINE` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `FAILURE_NOTIFY_ENABLED` | `empty` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `FUNDAMENTAL_CACHE_MAX_ENTRIES` | `256` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `FUNDAMENTAL_CACHE_TTL_SECONDS` | `120` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `FUNDAMENTAL_FETCH_TIMEOUT_SECONDS` | `8.0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `FUNDAMENTAL_RETRY_MAX` | `1` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `FUNDAMENTAL_STAGE_TIMEOUT_SECONDS` | `8.0` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `LLM_MAX_TOKENS` | `2048` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `LLM_MY_PROXY_MODEL_ID_MODE` | `route` | yes | commented template; custom services can use `literal` after discovery to preserve remote model IDs exactly. |
...
| `LLM_TIMEOUT_SEC` | `60` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `MCP_ANALYSIS_MAX_STOCKS` | `5` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_ANALYSIS_RATE_LIMIT_PER_MINUTE` | `2` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_ALLOWED_HOSTS` | `127.0.0.1:*,localhost:*,[::1]:*` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_ALLOWED_ORIGINS` | `http://127.0.0.1:*,http://localhost:*,http://[::1]:*` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_BACKLOG` | `16` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_KEEPALIVE_TIMEOUT_SECONDS` | `5` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_MAX_BODY_BYTES` | `1000000` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_MAX_CONNECTIONS` | `32` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_MAX_HEADER_BYTES` | `32768` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_READ_TIMEOUT_SECONDS` | `10` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_RESOURCE` | `http://127.0.0.1:8765/mcp` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_SCOPES` | `market.read,history.read` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_HTTP_SESSION_TOKEN_SHA256` | `empty` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_MAX_CONCURRENT_TOOLS` | `8` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_RATE_LIMIT_PER_MINUTE` | `60` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_SERVER_ENABLED` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_SERVER_HOST` | `127.0.0.1` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_SERVER_PORT` | `8765` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_SERVER_TRANSPORT` | `stdio` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_STDIO_PRINCIPAL` | `local-operator` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `MCP_STDIO_SCOPES` | `market.read,history.read` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `NEWSNOW_BASE_URL` | `https://newsnow.busiyi.world` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `NEWS_INTEL_AUTO_FETCH_ENABLED` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `NEWS_INTEL_FETCH_TIMEOUT_SEC` | `8` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `NEWS_INTEL_MAX_ITEMS_PER_SOURCE` | `50` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `NEWS_INTEL_RETENTION_DAYS` | `30` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `OUTBOUND_HTTP_ALLOWLIST` | `192.168.1.100:11434,searxng.internal:8080,10.0.0.20:3000` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PAPER_PORTFOLIO_INITIAL_CASH` | `1000000` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PLUGINS_DIR` | `/absolute/path/to/reviewed/plugins` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PLUGIN_DATA_PROVIDER_AUTO_BIND` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PLUGIN_STATE_PATH` | `./data/plugin_lifecycle_state.json` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_FX_UPDATE_ENABLED` | `true` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `PORTFOLIO_IDEMPOTENCY_REPLAY_WINDOW_DAYS` | `7` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_RISK_CONCENTRATION_ALERT_PCT` | `35.0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_RISK_DRAWDOWN_ALERT_PCT` | `15.0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_RISK_LOOKBACK_DAYS` | `180` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_RISK_STOP_LOSS_ALERT_PCT` | `10.0` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PORTFOLIO_RISK_STOP_LOSS_NEAR_RATIO` | `0.8` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `PROVIDER_DAILY_CACHE_LOCAL_ONLY_MAX_AGE_SECONDS` | `2592000` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `PROVIDER_DAILY_CACHE_PERSISTENT_MAX_AGE_SECONDS` | `7776000` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PROVIDER_DAILY_CACHE_PERSISTENT_MAX_ENTRIES` | `512` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PROVIDER_DAILY_CACHE_PERSISTENT_TTL_SECONDS` | `3600` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `PROVIDER_DAILY_CACHE_ROLLOVER_GRACE_DAYS` | `1` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `PROVIDER_MARKET_DATA_MODE` | `auto` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `REASONING_TRACE_EXPORT_ENABLED` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
| `REASONING_TRACE_EXPORT_MAX_CHARS` | `500000` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `REPORT_MODE` | `standard` | no | commented template; registry gap (see inventory docs / tracking issue) |
...
| `SMARTMONEY_ENABLED` | `false` | no | commented template; registry gap (see inventory docs / tracking issue) |
