...
| `AGENT_STEP_CRITIQUE_LLM_BUDGET` | `0` | yes | commented template; Optional LLM budget for step critique (0=deterministic) |
...
| `AGENT_REFLECTION_MAX_REVISE` | `1` | yes | commented template; Max in-run revise passes after trajectory reflection |
...
| `AGENT_META_REVIEW_LLM_BUDGET` | `0` | yes | commented template; Optional LLM budget for meta-review report |
