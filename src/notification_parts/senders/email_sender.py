...
class EmailSender:
    ...
    def __init__(self, config: Config):
        ...
        self._email_config = {
            ...
            'sender_name': getattr(config, 'email_sender_name', 'StockPulse'),
    ...
    def _close_server(server: Optional[smtplib.SMTP]) -> None:
        ...
        try:
            server.quit()
        except Exception:  # broad-exception: cleanup - Fall back to a direct close when graceful SMTP quit fails.
            try:
                server.close()
            except Exception:  # broad-exception: cleanup - Final socket cleanup cannot change the established send outcome.
                pass
    ...
    def send_to_email(
        ...
        *,
        ...
        try:
            ...
            return False
        except Exception as exc:  # broad-exception: fallback_recorded - Delivery failure is safely logged before returning false.
            log_safe_exception(
                logger,
    ...
    def _send_email_with_inline_image(
        ...
        try:
            ...
            return True
        except Exception as exc:  # broad-exception: fallback_recorded - Inline-image failure is safely logged before returning false.
            log_safe_exception(
                logger,
