"""Compatibility binding for legacy notification support module paths."""
...
def load_legacy_module(
    ...
    reload_existing = bool(facade_globals.get("_notification_facade_initialized"))
    ...
    facade_globals["_notification_facade_initialized"] = True
