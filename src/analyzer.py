...
def __clone_result_function(function: __FunctionType) -> __FunctionType:
    """Clone a result helper with the legacy analyzer facade as its globals."""
    ...
    rebound.__qualname__ = function.__name__
...
for __name_to_bind, __value_to_bind in vars(__result_processing).items():
    if (
        ...
        globals()[__name_to_bind] = __clone_result_function(__value_to_bind)
