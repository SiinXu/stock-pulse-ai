...
_STRATEGY_CONFLICT_TYPE_CANONICAL_MAP = {
    "directional opposition": "directional_opposition",
    "wide score dispersion": "wide_score_dispersion",
    "high confidence dissent": "high_confidence_dissent",
    "adjustment contradiction": "adjustment_contradiction",
}

_STRATEGY_CONFLICT_DESCRIPTION_TRANSLATIONS = {
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "presentation_profile_heading": "研究呈现偏好",
        "presentation_profile_conservative": "保守",
        "presentation_profile_balanced": "均衡",
        "presentation_profile_aggressive": "积极",
        "presentation_profile_framing_detail": "仅调整排序与强调；同一证据，风险披露完整度与其他偏好相同；研究框架辅助，非个性化投资建议",
        "positive_catalysts_label": "利好催化",
        "latest_news_label": "最新动态",
        "core_conclusion_heading": "核心结论",
        "one_sentence_label": "一句话决策",
        "info_quality_heading": "信息质量",
        "info_quality_grade_label": "质量等级",
        "forced_conclusion_heading": "强制结论",
        "forced_conclusion_stance_label": "结论立场",
        "forced_conclusion_uncertainty_label": "不确定性",
        ...
        "source_label": "行情来源",
        "quote_trust_heading": "行情可信度",
        "quote_trust_confidence_label": "分析置信度",
        "quote_trust_gaps_label": "缺口",
        "quote_trust_conflicts_label": "冲突数",
        "quote_trust_no_gaps_label": "无",
        ...
        "risk_manager_heading": "最终风控裁决",
        "risk_profile_label": "档位",
        "risk_verdict_label": "裁决",
        ...
        "financial_history_heading": "多期财报",
        "financial_recency_label": "数据时效",
        "fundamentals_sufficiency_label": "充分性",
        "insufficient_fundamentals_note": "insufficient fundamentals：无可用财报数值，禁止将缺失当作 0 或编造比率。",
        ...
        "committee_persona_confidence_label": "置信度",
        "active_research_persona_heading": "研究立场",
        ...
        "missing_or_conflicts_heading": "缺失数据或来源冲突",
        ...
        "fact_as_of_unknown_label": "时间未标注",
        "gap_kind_missing_label": "缺失",
        "gap_kind_conflict_label": "冲突",
        "valuation_heading": "估值估计",
        "valuation_status_label": "状态",
        "valuation_dcf_heading": "DCF",
        "valuation_relative_heading": "相对估值",
        "valuation_assumptions_heading": "关键假设",
        "valuation_sensitivity_heading": "敏感性区间（股权价值）",
        "valuation_equity_value_label": "股权价值",
        "valuation_intrinsic_per_share_label": "每股内在价值",
        "valuation_upside_label": "相对现价空间",
        "valuation_growth_rate_label": "增长率",
        "valuation_discount_rate_label": "折现率",
        "valuation_terminal_growth_label": "永续增长率",
        "valuation_projection_years_label": "预测年数",
        "valuation_cash_flow_source_label": "现金流来源",
        "valuation_net_debt_assumption_label": "净债务假设",
        "valuation_sensitivity_low_label": "低",
        "valuation_sensitivity_mid_label": "中",
        "valuation_sensitivity_high_label": "高",
        "valuation_vs_peers_label": "相对同业",
        "valuation_peer_median_label": "同业中位数",
        "valuation_implied_pe_label": "PE 隐含价",
        "valuation_implied_pb_label": "PB 隐含价",
        "valuation_implied_ev_ebitda_label": "EV/EBITDA 隐含股权价值",
        "valuation_model_disclaimer": "模型估算仅供研究参考，不是投资建议；结论对假设高度敏感。",
    },
    "en": {
        ...
        "presentation_profile_conservative": "conservative",
        "presentation_profile_balanced": "balanced",
        "presentation_profile_aggressive": "aggressive",
        "presentation_profile_framing_detail": "emphasis/ordering only; same evidence and full risk disclosure; research framing aid, not personalized advice",
        ...
        "info_quality_heading": "Information Quality",
        "info_quality_grade_label": "Quality Grade",
        "forced_conclusion_heading": "Forced Conclusion",
        "forced_conclusion_stance_label": "Stance",
        "forced_conclusion_uncertainty_label": "Uncertainty",
        ...
        "source_label": "Source",
        "quote_trust_heading": "Quote trust",
        "quote_trust_confidence_label": "Analysis confidence",
        "quote_trust_gaps_label": "Gaps",
        "quote_trust_conflicts_label": "Conflicts",
        "quote_trust_no_gaps_label": "none",
        ...
        "risk_manager_heading": "Final Risk Decision",
        "risk_profile_label": "Profile",
        "risk_verdict_label": "Verdict",
        ...
        "financial_history_heading": "Multi-period statements",
        "financial_recency_label": "Data recency",
        "fundamentals_sufficiency_label": "Sufficiency",
        "insufficient_fundamentals_note": "insufficient fundamentals: no usable statement figures; do not treat missing values as zero or invent ratios.",
        ...
        "committee_persona_confidence_label": "Confidence",
        "active_research_persona_heading": "Research Persona",
        ...
        "missing_or_conflicts_heading": "Missing Data or Source Conflicts",
        ...
        "fact_as_of_unknown_label": "timestamp missing",
        "gap_kind_missing_label": "Missing",
        "gap_kind_conflict_label": "Conflict",
        "valuation_heading": "Valuation Estimate",
        "valuation_status_label": "Status",
        "valuation_dcf_heading": "DCF",
        "valuation_relative_heading": "Relative Valuation",
        "valuation_assumptions_heading": "Key Assumptions",
        "valuation_sensitivity_heading": "Sensitivity Range (Equity Value)",
        "valuation_equity_value_label": "Equity value",
        "valuation_intrinsic_per_share_label": "Intrinsic value / share",
        "valuation_upside_label": "Upside vs price",
        "valuation_growth_rate_label": "Growth rate",
        "valuation_discount_rate_label": "Discount rate",
        "valuation_terminal_growth_label": "Terminal growth",
        "valuation_projection_years_label": "Projection years",
        "valuation_cash_flow_source_label": "Cash-flow source",
        "valuation_net_debt_assumption_label": "Net-debt assumption",
        "valuation_sensitivity_low_label": "Low",
        "valuation_sensitivity_mid_label": "Mid",
        "valuation_sensitivity_high_label": "High",
        "valuation_vs_peers_label": "vs peers",
        "valuation_peer_median_label": "Peer median",
        "valuation_implied_pe_label": "PE-implied price",
        "valuation_implied_pb_label": "PB-implied price",
        "valuation_implied_ev_ebitda_label": "EV/EBITDA-implied equity value",
        "valuation_model_disclaimer": "Model estimate for research support only. Not investment advice; highly sensitive to assumptions.",
    },
    "ko": {
        ...
        "presentation_profile_heading": "연구 프레젠테이션 프로필",
        "presentation_profile_conservative": "보수적",
        "presentation_profile_balanced": "균형",
        "presentation_profile_aggressive": "공격적",
        "presentation_profile_framing_detail": "강조/순서만 변경; 근거와 리스크 공개는 모든 프로필에서 동일; 연구용 프레이밍이며 맞춤 투자 권유가 아닙니다",
        "positive_catalysts_label": "긍정 촉매",
        "latest_news_label": "최신 뉴스",
        "core_conclusion_heading": "핵심 결론",
        "one_sentence_label": "한 줄 결론",
        "info_quality_heading": "정보 품질",
        "info_quality_grade_label": "품질 등급",
        "forced_conclusion_heading": "강제 결론",
        "forced_conclusion_stance_label": "결론 입장",
        "forced_conclusion_uncertainty_label": "불확실성",
        ...
        "source_label": "시세 출처",
        "quote_trust_heading": "시세 신뢰도",
        "quote_trust_confidence_label": "분석 신뢰도",
        "quote_trust_gaps_label": "공백",
        "quote_trust_conflicts_label": "충돌 수",
        "quote_trust_no_gaps_label": "없음",
        ...
        "risk_manager_heading": "최종 리스크 결정",
        "risk_profile_label": "프로필",
        "risk_verdict_label": "결정",
        ...
        "financial_history_heading": "다기간 재무제표",
        "financial_recency_label": "데이터 최신성",
        "fundamentals_sufficiency_label": "충분성",
        "insufficient_fundamentals_note": "insufficient fundamentals: 사용 가능한 재무제표 수치가 없습니다. 결측을 0으로 취급하거나 비율을 지어내지 마세요.",
        ...
        "committee_persona_confidence_label": "신뢰도",
        "active_research_persona_heading": "연구 페르소나",
        ...
        "missing_or_conflicts_heading": "누락 데이터 또는 출처 충돌",
        ...
        "fact_as_of_unknown_label": "시각 미표기",
        "gap_kind_missing_label": "누락",
        "gap_kind_conflict_label": "충돌",
        "valuation_heading": "밸류에이션 추정",
        "valuation_status_label": "상태",
        "valuation_dcf_heading": "DCF",
        "valuation_relative_heading": "상대 밸류에이션",
        "valuation_assumptions_heading": "핵심 가정",
        "valuation_sensitivity_heading": "민감도 구간(지분가치)",
        "valuation_equity_value_label": "지분가치",
        "valuation_intrinsic_per_share_label": "주당 내재가치",
        "valuation_upside_label": "현재가 대비 여력",
        "valuation_growth_rate_label": "성장률",
        "valuation_discount_rate_label": "할인율",
        "valuation_terminal_growth_label": "영구성장률",
        "valuation_projection_years_label": "예측 연수",
        "valuation_cash_flow_source_label": "현금흐름 출처",
        "valuation_net_debt_assumption_label": "순부채 가정",
        "valuation_sensitivity_low_label": "낮음",
        "valuation_sensitivity_mid_label": "중간",
        "valuation_sensitivity_high_label": "높음",
        "valuation_vs_peers_label": "동종 대비",
        "valuation_peer_median_label": "동종 중앙값",
        "valuation_implied_pe_label": "PE 암시 가격",
        "valuation_implied_pb_label": "PB 암시 가격",
        "valuation_implied_ev_ebitda_label": "EV/EBITDA 암시 지분가치",
        "valuation_model_disclaimer": "모델 추정은 연구 참고용이며 투자 권유가 아닙니다. 가정에 매우 민감합니다.",
    },
}
...
def format_strategy_skill_items(
    items: Any,
    language: Optional[str],
    *,
    include_details: bool = True,
) -> str:
    """Format renderer-safe strategy items with a localized empty label."""
    none_text = get_report_labels(language)["none_label"]
    ...
    for item in items:
        ...
        if not skill_id:
            continue
        text = localize_strategy_skill(skill_id, language)
        if include_details:
            signal = str(item.get("signal") or "").strip()
            if signal:
                text += f"/{localize_strategy_signal(signal, language)}"
    ...
    if isinstance(conflicts, list):
        for conflict in conflicts:
            ...
            normalized_conflict["participants"] = (
                [participant.strip() for participant in participants
