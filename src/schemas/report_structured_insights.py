...
"""Stable API projection for structured report insights.
...
def _project_phase_decision(value: Any) -> Optional[Dict[str, Any]]:
...
def _project_signal_attribution(value: Any) -> Optional[Dict[str, Any]]:
    if not isinstance(value, dict):
        return None
...
def _project_strategy_skill(value: Any) -> Optional[Dict[str, Any]]:
    if not isinstance(value, dict):
        return None
...
def _project_strategy_conflict(value: Any) -> Optional[Dict[str, Any]]:
    if not isinstance(value, dict):
        return None
...
def _project_strategy_synthesis(value: Any) -> Optional[Dict[str, Any]]:
