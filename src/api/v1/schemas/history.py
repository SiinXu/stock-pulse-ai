...
from src.api.v1.schemas.report_structured_insights import ReportStructuredInsights
...
class HistoryItem(BaseModel):
    ...
    region: Optional[str] = Field(None, description="Canonical market coverage for market-review records")
