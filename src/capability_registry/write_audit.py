...
Administrator-requested register / update / retire operations require the
existing privileged-operation audit chain. Audit unavailability aborts the
...
class CapabilityWriteAuditRecorder(Protocol):
    """Structural subset of ``SecurityAuditRecorder`` used by write mutations."""
...
class CapabilityWriteAuditor:
    ...
    def begin(
        ...
        *,
        ...
        """Record an attempt; raise SecurityAuditUnavailable on failure."""
    ...
    def complete(
        ...
        *,
        ...
        """Record completion; raise SecurityAuditUnavailable on failure."""
        ...
        try:
            ...
            if outcome is not None:
                ...
                reason = error_code or f"capability_{operation}_{outcome}"
            elif success:
    ...
    def record_denied(
        ...
        *,
        capability_id: str,
        operation: str,
        reason_code: str = "capability_write_unauthorized",
        metadata: Mapping[str, Any] | None = None,
        actor_type: str | None = None,
        actor_id: str | None = None,
    ) -> str:
        """Record attempt+denied completion for an unauthorized write attempt."""
        ...
        correlation_id = self.begin(
            ...
            actor_id=actor_id or "unauthenticated",
        )
        self.complete(
            capability_id=capability_id or "unknown",
            operation=operation,
