...
SYSTEM_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DAILY_BRIEF_QUIET_WHEN_EMPTY": {
        ...
        "default_value": "false", "options": [], "validation": {}, "display_order": 66,
        "help_key": "settings.system.daily_brief",
    ...
    "EVENT_RESEARCH_BRIEF_ENABLED": {
        ...
        "category": "system", "data_type": "boolean", "ui_control": "switch",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "false", "options": [], "validation": {}, "display_order": 67,
    ...
    "EVENT_RESEARCH_BRIEF_NOTIFY": {
        ...
        "category": "system", "data_type": "boolean", "ui_control": "switch",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "true", "options": [], "validation": {}, "display_order": 68,
        "help_key": "settings.system.event_research_brief",
    ...
    "EVENT_RESEARCH_BRIEF_PERSIST_HISTORY": {
        ...
        "category": "system", "data_type": "boolean", "ui_control": "switch",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "true", "options": [], "validation": {}, "display_order": 69,
        "help_key": "settings.system.event_research_brief",
    ...
    "EVENT_RESEARCH_BRIEF_SAVE_REPORT_FILE": {
        ...
        "category": "system", "data_type": "boolean", "ui_control": "switch",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "true", "options": [], "validation": {}, "display_order": 70,
        "help_key": "settings.system.event_research_brief",
    ...
    "EVENT_RESEARCH_BRIEF_LOOKBACK_HOURS": {
        ...
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "48", "options": [], "validation": {"min": 1, "max": 168}, "display_order": 71,
        "help_key": "settings.system.event_research_brief",
    ...
    "EVENT_RESEARCH_BRIEF_CATEGORIES": {
        ...
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "earnings", "options": [], "validation": {"max_length": 128}, "display_order": 72,
        "help_key": "settings.system.event_research_brief",
