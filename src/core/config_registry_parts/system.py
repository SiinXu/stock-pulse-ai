...
SYSTEM_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LOCAL_ONLY_MODE": {
        ...
        "description": (
            ...
            "destination that uses the shared helpers, including plugin_safe_*. Pure "
            "loopback HTTP remains allowed. Blocked policy-owned calls raise coded "
            "LOCAL_ONLY_MODE errors and never silently fall through. Desktop update "
            "checks skip. Non-HTTP provider sockets stay outside this gate. Sanctioned "
            "plugin HTTP is gated; raw in-process plugin execution is not a sandbox."
        ),
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
    ...
    "CAPABILITY_WRITE_REGISTRY_PATH": {
        ...
        "description": "Optional path for the durable write-side capability registry. Empty uses <dir-of-DATABASE_PATH>/capability_write_registry.json.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {"maxLength": 1024},
        "display_order": 45,
        "help_key": "settings.system.CAPABILITY_WRITE_REGISTRY_PATH",
        "examples": ["CAPABILITY_WRITE_REGISTRY_PATH=./data/capability_write_registry.json"],
        "docs": [{"label": "Capability inventory", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/capability-inventory.md"}],
        "warning_codes": ["restart_required"],
    },
    "TASK_ROUTING_ENABLED": {
        "title": "Task-Aware Model Routing",
        "description": "Opt-in automatic model selection by task class using write-side LLM capability tags. Manual pins always win. Default off.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 46,
        "help_key": "settings.system.TASK_ROUTING_ENABLED",
    ...
    "TASK_ROUTING_POLICY": {
        ...
        "description": "Scoring policy for automatic task-aware model selection: quality, cost, or local_first.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"label": "Local first", "value": "local_first"},
        ],
        "validation": {"enum": ["quality", "cost", "local_first"]},
        "display_order": 47,
        "help_key": "settings.system.TASK_ROUTING_POLICY",
        "examples": ["TASK_ROUTING_POLICY=quality", "TASK_ROUTING_POLICY=cost", "TASK_ROUTING_POLICY=local_first"],
        "docs": [{"label": "Capability inventory", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/capability-inventory.md"}],
        "warning_codes": [],
    },
    "TASK_ROUTING_PIN_REPORT": {
        "title": "Task Route Pin (Report)",
        "description": "Optional explicit model pin for report generation.",
    ...
    "TASK_ROUTING_PIN_AGENT": {
        ...
        "description": "Optional explicit model pin for Agent tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "TASK_ROUTING_PIN_VISION": {
        ...
        "description": "Optional explicit model pin for vision tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "TASK_ROUTING_PIN_MARKET_REVIEW": {
        ...
        "description": "Optional explicit model pin for market-review tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "TASK_ROUTING_PIN_CHEAP_SCAN": {
        ...
        "description": "Optional explicit model pin for cheap-scan tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "TASK_ROUTING_PIN_DEEP_REASONING": {
        ...
        "description": "Optional explicit model pin for deep-reasoning tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "TASK_ROUTING_PIN_CODING": {
        ...
        "description": "Optional explicit model pin for coding-oriented tasks.",
        "category": "system", "data_type": "string", "ui_control": "text",
        "is_sensitive": False, "is_required": False, "is_editable": True,
        "default_value": "", "options": [], "validation": {"maxLength": 256},
    ...
    "PORTFOLIO_AWARE_SIZING_ENABLED": {
        "title": "Portfolio-aware Sizing Enabled",
        "description": "Use current portfolio weights when deriving deterministic position bands.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 88,
        "help_key": "settings.system.portfolio_aware_sizing",
        "examples": ["PORTFOLIO_AWARE_SIZING_ENABLED=true"],
        "docs": [{
            "label": "Portfolio rebalancing",
            "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/portfolio-rebalancing_EN.md",
        }],
        "warning_codes": [],
    },
    "PORTFOLIO_MAX_SINGLE_NAME_WEIGHT": {
        "title": "Portfolio Maximum Single-name Weight",
        "description": "Soft global single-name position cap expressed as a fraction from 0 to 1.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 89,
        "help_key": "settings.system.portfolio_aware_sizing",
        "examples": ["PORTFOLIO_MAX_SINGLE_NAME_WEIGHT=0.15"],
        "docs": [{
            "label": "Portfolio rebalancing",
            "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/portfolio-rebalancing_EN.md",
        }],
