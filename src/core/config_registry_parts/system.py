...
SYSTEM_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ANALYSIS_CHECKPOINT_ENABLED": {
        ...
        "description": (
            "Persist multi-agent and pipeline stage outputs so interrupted analyses can exact-replay "
            "from the last completed stage. Resume is refused when the compatibility fingerprint differs."
        ),
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        ...
        "validation": {},
        "display_order": 51.1,
        "help_key": "settings.system.ANALYSIS_CHECKPOINT_ENABLED",
    ...
    "ANALYSIS_CHECKPOINT_DIR": {
        "title": "Analysis Checkpoint Directory",
    ...
    "ANALYSIS_CHECKPOINT_FORCE_FULL": {
        ...
        "validation": {},
        "display_order": 51.4,
        "help_key": "settings.system.ANALYSIS_CHECKPOINT_FORCE_FULL",
        "examples": ["ANALYSIS_CHECKPOINT_FORCE_FULL=false", "ANALYSIS_CHECKPOINT_FORCE_FULL=true"],
        "docs": [{"label": "Analysis checkpoint and reproducibility", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/analysis-checkpoint-resume.md"}],
        "warning_codes": [],
    },
    "REPRO_MODE_ENABLED": {
        "title": "Reproducibility Mode",
        "description": "Prefer deterministic local settings (pin random seed and temperature=0 where supported). Provider-side non-determinism may still remain.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 51.5,
        "help_key": "settings.system.REPRO_MODE_ENABLED",
        "examples": ["REPRO_MODE_ENABLED=false", "REPRO_MODE_ENABLED=true", "REPRO_SEED=0"],
        "docs": [{"label": "Analysis checkpoint and reproducibility", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/analysis-checkpoint-resume.md"}],
        "warning_codes": [],
    },
    "REPRO_RECORD_CONFIG": {
        "title": "Record Run Configuration Snapshot",
        "description": "Always record models, temperature, pipeline flags, skills, and version markers into report metadata.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 51.6,
        "help_key": "settings.system.REPRO_RECORD_CONFIG",
    ...
    "REPRO_SEED": {
        ...
        "description": "Integer seed applied when reproducibility mode is enabled. Default 0 when mode is on and seed is unset.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0},
        "display_order": 51.7,
        "help_key": "settings.system.REPRO_SEED",
