...
"SKILL_OPINION_RECORDING_ENABLED": {
    ...
    "PREDICTION_EXTRACT_ENABLED": {
        ...
        "description": (
            ...
            "extraction failures never fail analysis. One user-visible analysis "
            "persists at most one pending agent_predictions row per symbol; the "
            "attached prediction_id equals the stored primary key. Re-finalize "
            "reuses the existing row and never overwrites after resolve."
        ),
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
    ...
    "AGENT_EPISODE_LOG_ENABLED": {
        ...
        "description": (
            "Append compact agent evolution episodes (trajectory summary, lessons, "
            "optional outcome labels). Default off. Failures never abort analysis. "
            "Does not store API keys, raw provider payloads, or full Soul charter text."
        ),
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        ...
        "examples": ["AGENT_EPISODE_LOG_ENABLED=false", "AGENT_EPISODE_LOG_ENABLED=true"],
        "docs": [{
            "label": "Agent episode log (EN)",
            "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/agent-episode-log_EN.md",
        }],
        "warning_codes": [],
    },
    ...
    "PREDICTION_RESOLVE_ENABLED": {
        ...
        "description": (
            "Enable automatic prediction resolution via the existing process scheduler "
            "(Issues #1102 / #1116). Due predictions are claimed, scored against server-path "
            "actuals, and written back without user action. Provider failures mark "
            "data_unavailable and retry — never fabricate hit/miss. Default off."
        ),
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        ...
        "docs": [
            {
                ...
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
            },
        ],
        "warning_codes": [],
    },
    "PREDICTION_RESOLVE_INTERVAL_SECONDS": {
        "title": "Prediction Resolver Interval",
        "description": "Seconds between PredictionResolver.tick runs (scheduler floor 30s).",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PREDICTION_RESOLVE_MAX_PER_TICK": {
        "title": "Prediction Resolver Batch Cap",
        "description": "Maximum due predictions claimed per PredictionResolver.tick.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PREDICTION_RESOLVE_LEASE_SECONDS": {
        "title": "Prediction Resolver Lease TTL",
        "description": "Seconds a resolving lease is held to prevent double-scoring.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PREDICTION_RESOLVE_FETCH_CONCURRENCY": {
        "title": "Prediction Resolver Fetch Concurrency",
        "description": "Global worker cap for concurrent actuals fetch groups.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 725,
        "help_key": "settings.agent.prediction_resolve",
        "examples": ["PREDICTION_RESOLVE_FETCH_CONCURRENCY=4"],
        "docs": [
            {
                "label": "Prediction resolver",
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
    ...
    "PREDICTION_RESOLVE_POSTMORTEM_MAX_PER_TICK": {
        "title": "Prediction Resolver Postmortem Budget",
        "description": "Maximum miss/partial postmortem jobs handed off per tick.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 726,
        "help_key": "settings.agent.prediction_resolve",
        "examples": ["PREDICTION_RESOLVE_POSTMORTEM_MAX_PER_TICK=10"],
        "docs": [
            {
                "label": "Prediction resolver",
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
    ...
    "PREDICTION_RESOLVE_PROVIDER_ERROR_CIRCUIT_THRESHOLD": {
        "title": "Prediction Resolver Circuit Threshold",
        "description": "Failed actuals groups in one tick before the provider circuit opens.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 727,
        "help_key": "settings.agent.prediction_resolve",
        "examples": ["PREDICTION_RESOLVE_PROVIDER_ERROR_CIRCUIT_THRESHOLD=5"],
        "docs": [
            {
                "label": "Prediction resolver",
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
    ...
    "PREDICTION_RESOLVE_PROVIDER_ERROR_CIRCUIT_COOLDOWN_SECONDS": {
        "title": "Prediction Resolver Circuit Cooldown",
        "description": "Seconds to keep the provider error circuit open.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PREDICTION_RESOLVE_CIRCUIT_OPEN_MAX_PER_TICK": {
        "title": "Prediction Resolver Open-Circuit Batch Cap",
        "description": "Reduced per-tick claim cap while the provider circuit is open.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 729,
        "help_key": "settings.agent.prediction_resolve",
        "examples": ["PREDICTION_RESOLVE_CIRCUIT_OPEN_MAX_PER_TICK=5"],
        "docs": [
            {
                "label": "Prediction resolver",
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
    ...
    "PREDICTION_RESOLVE_RETRY_JITTER_RATIO": {
        "title": "Prediction Resolver Retry Jitter",
        "description": "Positive jitter ratio applied to bounded exponential retry delays.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "display_order": 730,
        "help_key": "settings.agent.prediction_resolve",
        "examples": ["PREDICTION_RESOLVE_RETRY_JITTER_RATIO=0.1"],
        "docs": [
            {
                "label": "Prediction resolver",
                "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/prediction-resolver_EN.md",
