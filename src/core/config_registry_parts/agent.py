...
"SKILL_OPINION_RECORDING_ENABLED": {
    ...
    "AGENT_STEP_CRITIQUE_ENABLED": {
        ...
        "validation": {},
        "display_order": 726,
        "help_key": "settings.agent.AGENT_STEP_CRITIQUE_ENABLED",
    ...
    "AGENT_STEP_CRITIQUE_LLM_BUDGET": {
        "title": "Step Critique LLM Budget",
        "description": (
            "Maximum optional LLM calls for one immediate step-critique pass "
            "(default 0 = deterministic taxonomy mapping only)."
        ),
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        ...
        "validation": {"min": 0},
        "display_order": 727,
        "help_key": "settings.agent.AGENT_STEP_CRITIQUE_LLM_BUDGET",
        "examples": ["AGENT_STEP_CRITIQUE_LLM_BUDGET=0", "AGENT_STEP_CRITIQUE_LLM_BUDGET=1"],
        "docs": [{"label": "Multi-level reflection", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/agent-multi-level-reflection_EN.md"}],
        "warning_codes": [],
    },
    ...
    "AGENT_REFLECTION_MAX_REVISE": {
        "title": "Trajectory Reflection Max Revise",
        "description": "Maximum in-run revise passes after trajectory reflection (default 1).",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "examples": ["AGENT_REFLECTION_MAX_REVISE=1", "AGENT_REFLECTION_MAX_REVISE=0"],
        "docs": [{"label": "Multi-level reflection", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/agent-multi-level-reflection_EN.md"}],
        "warning_codes": [],
    },
    "AGENT_META_REVIEW_ENABLED": {
        ...
        "validation": {},
        "display_order": 731,
        "help_key": "settings.agent.AGENT_META_REVIEW_ENABLED",
    ...
    "AGENT_META_REVIEW_MIN_EPISODES": {
        ...
        "validation": {"min": 1},
        "display_order": 732,
        "help_key": "settings.agent.AGENT_META_REVIEW_MIN_EPISODES",
        "examples": ["AGENT_META_REVIEW_MIN_EPISODES=30", "AGENT_META_REVIEW_MIN_EPISODES=10"],
        "docs": [{"label": "Multi-level reflection", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/agent-multi-level-reflection_EN.md"}],
        "warning_codes": [],
    },
    "AGENT_META_REVIEW_LLM_BUDGET": {
        "title": "Meta Review LLM Budget",
        "description": "Maximum optional LLM calls for one offline meta-review run (default 0).",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0},
        "display_order": 733,
        "help_key": "settings.agent.AGENT_META_REVIEW_LLM_BUDGET",
        "examples": ["AGENT_META_REVIEW_LLM_BUDGET=0", "AGENT_META_REVIEW_LLM_BUDGET=1"],
        "docs": [{"label": "Multi-level reflection", "href": "https://github.com/SiinXu/stock-pulse-ai/blob/main/docs/agent-multi-level-reflection_EN.md"}],
        "warning_codes": [],
    },
