# ORM schema source for the public src.storage facade.

if __name__ != "src.storage":
...
class ScheduledTaskRecord(Base):
    ...
    execution_generation = Column(Integer, nullable=False, default=1)
...
class ScheduledTaskRunRecord(Base):
    ...
    definition_schema_version = Column(Integer, nullable=False)
    definition_generation = Column(Integer, nullable=False)
    dispatch_token = Column(String(32))
    status = Column(String(16), nullable=False, index=True)
    attempt_count = Column(Integer, nullable=False, default=0)
    dispatch_failure_count = Column(Integer, nullable=False, default=0)
    ...
    notification_status = Column(String(24))
    notification_channels_json = Column(Text, nullable=False, default='[]')
    notification_failed_channels_json = Column(Text, nullable=False, default='[]')
