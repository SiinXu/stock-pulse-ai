...
"""Re-export of the shared ADR-006 rebind helpers for the tushare parts package.

The implementation lives in ``src.data_provider._facade_bind``. This module is
kept so existing imports such as
``from .tushare_parts.facade_bind import bind_methods_from_class`` keep working.
"""
