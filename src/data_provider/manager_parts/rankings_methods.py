...
facade. These descriptors own sector/concept rankings, hot-stock, and
limit-up-pool routing plus the shared concept-rankings cache helpers.
Cache TTL/lock/dict class attributes stay on the facade. ``BaseFetcher``
provider methods with the same names are not part of this owner.
...
EXPECTED_RANKINGS_METHOD_NAMES = (
