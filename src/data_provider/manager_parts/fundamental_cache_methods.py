...
facade. Cache maps and locks remain on the facade. CN/offshore aggregation
loaders are owned by ``fundamental_loader_methods``. This is instance-local
and is not the 5s realtime/chip process helper.
"""
