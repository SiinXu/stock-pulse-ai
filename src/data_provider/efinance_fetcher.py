...
# compatibility facade while ``efinance_parts`` owns ETF fetch/realtime bodies.
...
def _install_part_reload_hooks() -> None:
    ...
    _etf_module._FACADE_RELOAD_HOOK = _assemble_efinance_fetcher_facade  # type: ignore[attr-defined]
