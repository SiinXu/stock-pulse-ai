...
# money-flow cache lookup/store, fundamental cache lookup/inflight,
# fundamental context aggregation, and belong-board normalization.
...
def _assemble_fundamental_context_methods_facade(
    context_module=_fundamental_context_methods_module,
) -> None:
    bound_method_names = context_module.bind_fundamental_context_methods_facade(
        DataFetcherManager,
        globals(),
    )
    if bound_method_names != context_module.EXPECTED_FUNDAMENTAL_CONTEXT_METHOD_NAMES:
        raise ImportError(
...
_fundamental_context_methods_module._install_facade_reload_hook(
    _assemble_data_fetcher_manager_facades
)
