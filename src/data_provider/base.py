...
# bookkeeping, money-flow cache lookup/store, fundamental cache
# lookup/inflight, and belong-board normalization. Rebinding preserves
# method globals so existing patches against this module continue to
