...
from src.repositories.investment_framework_repo import (
    ...
    InvestmentFrameworkRepositoryError as RepositoryError,
...
class InvestmentFrameworkDataError(RuntimeError):
    """Raised when persisted framework state violates its storage contract."""
...
class InvestmentFrameworkService:
        ...
        *,
        ...
        try:
            ...
            raise InvestmentFrameworkDataError(
                "Investment framework storage is inconsistent"
            ) from exc
    ...
    def _validate_expected_revision(expected_revision: int) -> int:
        if type(expected_revision) is not int or expected_revision < 1:
            raise InvestmentFrameworkServiceError(
    ...
    def _normalize_content(
        ...
        candidate = InvestmentFrameworkContent.model_validate(content)
        return InvestmentFrameworkContent.model_validate(
