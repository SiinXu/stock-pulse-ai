...
class _SystemConfigWriteAuditMethods:
    ...
    _DEFAULT_WRITE_AUDIT_ACTOR_ID = "local_operator"
    _WRITE_AUDIT_ACTOR_IDS = frozenset(
        {
            "local_operator",
            "authenticated_admin",
            "desktop_operator",
    ...
    def _write_audit_actor(self, audit_actor_id: Any = None) -> str:
        if (
            type(audit_actor_id) is str
            and audit_actor_id in self._WRITE_AUDIT_ACTOR_IDS
        ):
            return audit_actor_id
        return self._DEFAULT_WRITE_AUDIT_ACTOR_ID
        ...
        *,
        ...
        try:
            ...
            common = dict(
                ...
                actor_id=self._write_audit_actor(actor_id),
    ...
    def update(
        ...
        *,
        ...
        resolved_actor_id = self._write_audit_actor(audit_actor_id)
