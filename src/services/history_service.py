...
class HistoryService:
    ...
    @staticmethod
    def _extract_market_review_region(context_snapshot) -> Optional[str]:
    ...
    def _generate_single_stock_markdown(
        ...
        if isinstance(multi_model, dict) and multi_model.get("enabled"):
            ...
            if isinstance(degradation, dict) and (degradation.get("annotation") or degradation.get("reason")):
                report_lines.append(
