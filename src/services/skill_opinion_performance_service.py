...
"""Read-only statistics over attributable skill-opinion outcomes."""
...
class SkillOpinionPerformanceService:
    ...
    def get_stats(
        ...
        *,
        ...
        """Return low-sensitivity statistics for exact independent buckets."""
        ...
        return {
            "engine_version": engine_version_norm,
            "minimum_evaluated_sample_size": (
                MIN_SKILL_OUTCOME_SAMPLE_SIZE
            ),
            "buckets": [
                self._serialize_bucket(bucket) for bucket in buckets
            ],
        }
