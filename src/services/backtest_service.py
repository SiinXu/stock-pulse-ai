...
class BacktestService:
    ...
    def run_backtest(
        ...
        *,
        ...
        for analysis in candidates:
            ...
            try:
                ...
                if (
                    ...
                    and (
                        ...
                        or len(daily_window.forward_bars) < eval_window_days
                    )
                ):
            ...
            except Exception as exc:  # broad-exception: fallback_recorded - the failed evaluation is safe-logged and persisted as an error result.
                errors += 1
                log_safe_exception(
                    logger,
    ...
    def _normalize_summary_code(code: Optional[str]) -> Optional[str]:
        ...
        if raw_code.upper().startswith("SS"):
            identity = resolve_daily_stock_identity(raw_code)
            if identity is not None:
                normalized = identity.normalized_code
