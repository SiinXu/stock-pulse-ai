...
class AggregationData:
    """Deterministic aggregation output consumed by the strategy synthesizer."""
...
class SkillAggregator:
    ...
    def calculate(
        ...
        strategy_opinions = [strategy_opinion_from_agent_opinion(op) for op in skill_opinions]
        ...
        insufficient_evidence = not valid_opinions_with_weights or valid_weight_sum <= 0
