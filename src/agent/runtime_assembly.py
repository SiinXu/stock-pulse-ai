...
# Keep the established logger name while the implementation moves behind the
# backward-compatible ``src.agent.factory`` facade.
logger = logging.getLogger("src.agent.factory")
