...
describe('theme token freeze guard', () => {
  ...
  it('keeps unused Home panel-border-selected wrapper absent from definitions and inventory', () => {
    const unusedHomePanelBorderSelectedWrapper = '--home-panel-border-selected';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomePanelBorderSelectedWrapper).not.toContain(unusedHomePanelBorderSelectedWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomePanelBorderSelectedWrapper).not.toContain(unusedHomePanelBorderSelectedWrapper);
  });

  it('keeps unused Home panel-gradient-start wrapper absent from definitions and inventory', () => {
    const unusedHomePanelGradientStartWrapper = '--home-panel-gradient-start';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomePanelGradientStartWrapper).not.toContain(unusedHomePanelGradientStartWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomePanelGradientStartWrapper).not.toContain(unusedHomePanelGradientStartWrapper);
  });

  it('keeps unused Home panel-gradient-mid wrapper absent from definitions and inventory', () => {
    const unusedHomePanelGradientMidWrapper = '--home-panel-gradient-mid';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomePanelGradientMidWrapper).not.toContain(unusedHomePanelGradientMidWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomePanelGradientMidWrapper).not.toContain(unusedHomePanelGradientMidWrapper);
  });

  it('keeps unused Home panel-gradient-end wrapper absent from definitions and inventory', () => {
    const unusedHomePanelGradientEndWrapper = '--home-panel-gradient-end';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomePanelGradientEndWrapper).not.toContain(unusedHomePanelGradientEndWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomePanelGradientEndWrapper).not.toContain(unusedHomePanelGradientEndWrapper);
  });

  it('keeps unused Home history-item-bg wrapper absent from definitions and inventory', () => {
    const unusedHomeHistoryItemBgWrapper = '--home-history-item-bg';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomeHistoryItemBgWrapper).not.toContain(unusedHomeHistoryItemBgWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomeHistoryItemBgWrapper).not.toContain(unusedHomeHistoryItemBgWrapper);
  });

  it('keeps unused Home rail-border wrapper absent from definitions and inventory', () => {
    const unusedHomeRailBorderWrapper = '--home-rail-border';
    const definedNames = uniqueDefinedCustomPropertyNames(indexCss);
    expect(definedNames, unusedHomeRailBorderWrapper).not.toContain(unusedHomeRailBorderWrapper);
    expect(THEME_DEFINED_TOKEN_NAMES, unusedHomeRailBorderWrapper).not.toContain(unusedHomeRailBorderWrapper);
  });
