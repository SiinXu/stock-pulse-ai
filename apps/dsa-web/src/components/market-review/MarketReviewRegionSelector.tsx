  ...
  return (
    <div ref={containerRef} className="relative min-w-0 flex-1 basis-full sm:basis-auto">
      <button
        ...
        className={cn(
          'flex h-10 w-full min-w-0 items-center gap-2 rounded-xl border border-subtle bg-hover px-3 text-left text-xs text-secondary-text transition-colors',
      ...
      {menuOpen ? (
        <div
          ...
          className="absolute right-0 z-40 mt-2 w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-subtle bg-card p-2 shadow-2xl shadow-black/25 backdrop-blur-sm"
        >
          ...
          <div className="space-y-1 py-2">
            <button
              ...
              className={cn(
                ...
                value === undefined ? 'bg-primary/12 text-primary' : 'text-secondary-text hover:bg-hover hover:text-foreground',
              )}
            >
