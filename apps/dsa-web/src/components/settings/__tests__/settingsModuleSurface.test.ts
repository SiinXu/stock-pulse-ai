...
const SOURCE_EXPORT_SURFACES = {
  ...
  'src/components/settings/llmChannelEditorModel.ts': [
    ...
    'type:ChannelValidationIssueCode',
    'type:LLMChannelEditorProps',
    'type:LlmConnectionCheckInput',
    'type:LlmConnectionCheckOutcome',
    'type:ModelReferenceReplacement',
    'type:TaskModelReference',
    'value:CHANNEL_VALIDATION_ISSUE_CODES',
    ...
    'value:findChannelValidationIssue',
    'value:formatProtocolLabel',
    'value:getChannelCompletenessIssues',
    'value:getChannelDisplayNameIssues',
    'value:getChannelNameConflictIssue',
    'value:getChannelNameIssues',
    'value:getChannelSaveIssues',
    'value:getLlmCapabilityLabel',
    'value:hasRuntimeOnlyMaskedConnectionSecret',
    'value:isChannelValidationIssue',
    ...
    'value:runLlmConnectionCheck',
    'value:shouldUseSavedConnectionSecret',
    'value:splitModels',
