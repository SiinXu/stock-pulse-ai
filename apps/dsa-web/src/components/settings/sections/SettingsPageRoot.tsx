...
import { ApiErrorAlert, AppPage, Button, ConfirmDialog, PageHeader, ToastViewport, type SearchableSelectOption } from '../../common';
...
import { connectionItemsRespectSchema } from '../settingsConnectionUpdateContract';
...
} from '../settingsGenerationDraftModel';
import SettingsConflictPanel from '../SettingsConflictPanel';
import SettingsActiveConfigPanel from '../SettingsActiveConfigPanel';
import { SettingsOnboardingHosts } from '../../onboarding/SettingsOnboardingHosts';
import {
  SETTINGS_SECTIONS,
  getDefaultView,
  getSectionViews,
...
import { keyBelongsToSection, placementForKey, SCHEDULER_SETTING_KEYS } from '../settingsFieldPlacement';
import {
...
import TokenUsagePage from '../../usage/TokenUsagePage';
import {
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[220px_minmax(0,1fr)]">
          ...
          <section ref={contentRegionRef} tabIndex={-1} className="space-y-4 outline-none">
            ...
            <SystemSecuritySection
              ...
              handleSchedulerRuntimeStateChange={handleSchedulerRuntimeStateChange}
              setDraftValue={setDraftValue}
              allValuesByKey={allValuesByKey}
              t={t}
              language={uiLanguage}
            />
<AgentBehaviorSection isInvestmentFrameworkView={isInvestmentFrameworkView} />
                        <AdvancedSection
            ...
            <NotificationsSection
              ...
              configVersion={configVersion}
              settingsPanelDiagnosticHint={settingsPanelDiagnosticHint}
              rawActiveItems={rawActiveItems}
              maskToken={maskToken}
              isSaving={isSaving}
              isLoading={isLoading}
