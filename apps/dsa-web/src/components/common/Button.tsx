...
const BUTTON_SIZE_STYLES = {
  xsm: 'h-6 min-w-6 rounded-full px-2.5 text-xs',
  sm: 'h-8 min-w-8 rounded-full px-3 text-xs',
  md: 'h-9 min-w-9 rounded-full px-3.5 text-sm',
  lg: 'h-10 min-w-10 rounded-full px-4 text-sm',
  xl: 'h-11 min-w-11 rounded-full px-5 text-sm',
  icon: 'h-9 w-9 min-w-9 shrink-0 rounded-full p-0 text-sm',
} as const;
