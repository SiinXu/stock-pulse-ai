...
describe('ReportDiagnostics', () => {
  ...
  it('uses English UI chrome for a Chinese report without translating raw diagnostics', () => {
    ...
    expect(screen.getAllByText(diagnosticSummary.reason)).toHaveLength(2);
  });

  it('uses Chinese UI chrome for an English report', () => {
