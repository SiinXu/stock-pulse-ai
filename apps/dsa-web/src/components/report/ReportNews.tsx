...
import { ApiErrorAlert, Badge, Button, Card, Spinner, Surface } from '../common';
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                {item.url && (
                  <a
                    ...
                    className="control-hit-target inline-flex min-h-8 min-w-8 shrink-0 items-center justify-center gap-1 whitespace-nowrap rounded-lg border border-border bg-hover px-2.5 py-1 text-xs text-foreground transition-colors hover:bg-subtle-hover focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/25"
