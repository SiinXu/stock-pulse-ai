...
import { FIELD_TRUST_TEXT, fieldTrustGapMessage, fieldTrustStatusMessage } from '../../locales/fieldTrust';
import type {
        ...
        <div className="space-y-4">
          {showUnavailable ? (
            <InlineAlert
              ...
              message={fieldTrustStatusMessage(text, 'unavailable')}
          ...
          {showDegraded ? (
            <InlineAlert
              ...
              message={fieldTrustStatusMessage(text, 'degraded')}
