...
const mockStoreState = {
  ...
  retryLastStream: mockRetryLastStream,
...
describe('ChatPage', () => {
  it('links an unavailable Agent directly to model sources', async () => {
  ...
  it('writes a selected session to the URL', async () => {
    mockStoreState.sessions = [
      ...mockStoreState.sessions,
      {
  ...
  it('renders a separate delete button for each session and opens confirmation without switching', async () => {
    ...
    expect(deleteButton).toHaveClass('absolute', 'h-7', 'w-7', 'rounded-md');
  ...
  it('offers an explicit retry for the last failed chat stream', async () => {
  ...
  it('blocks sending until report follow-up context hydration completes', async () => {
