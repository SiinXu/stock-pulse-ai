...
export const ERROR_CODE_TAXONOMY: Readonly<Record<string, ErrorClassification>> = {
  ...
  audit_export_auth_required: entry('auth', 'error', 'settings', { docsPath: 'docs/security-baseline.md', href: SETTINGS_AUTH }),
  audit_export_disabled: entry('capability', 'warning', 'settings', { href: SETTINGS_AGENT }),
  ...
  evidence_chain_auth_required: entry('auth', 'error', 'settings', { docsPath: 'docs/security-baseline.md', href: SETTINGS_AUTH }),
  evidence_chain_disabled: entry('capability', 'warning', 'settings', { href: SETTINGS_AGENT }),
  ...
  research_pack_auth_required: entry('auth', 'error', 'settings', { docsPath: 'docs/security-baseline.md', href: SETTINGS_AUTH }),
  research_pack_export_disabled: entry('capability', 'warning', 'settings', { href: SETTINGS_AGENT }),
  research_pack_limit_exceeded: entry('capability', 'warning', 'settings', { href: SETTINGS_AGENT }),
