...
export function installPlaygroundApiMock(
    ...
    markets: [
      {
        ...
        ordered_provider_ids: ['akshare', 'tushare'],
        primary_provider_id: 'akshare',
        fallback_provider_ids: ['tushare'],
        primary_selection: 'first_eligible_with_health',
        quality: 'ok',
        as_of: null,
      },
    ],
    providers: [
      {
        ...
        sample_count: 3,
        static_priority: 5,
        last_success_at: '2026-08-12T00:00:00+00:00',
      ...
      },
      {
        ...
        last_failure_at: null,
        failure_reason: 'provider_availability_probe_false',
        is_primary_for: [],
        is_fallback_for: ['daily_data:cn'],
        config_directory: true,
      },
    ],
    cache: {
      enabled: true,
      fetch_mode: 'remote_first',
      hits: 2,
      misses: 1,
      stale_hits: 0,
      writes: 1,
  ...
  mock.onGet('/api/v1/system/config/data-providers/runtime-status').reply(() => responseFor(
    profile,
    dataProviderRuntimeOk as Record<string, unknown>,
    {
      schema_version: 'data_provider_runtime_status_v1',
      as_of: '2026-08-12T00:00:00+00:00',
      partial: true,
      ...
      error_message: 'Data provider runtime is not initialized in this process.',
      markets: [],
      providers: [],
      cache: null,
