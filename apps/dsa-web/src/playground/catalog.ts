...
export const PLAYGROUND_CATALOG: readonly PlaygroundEntry[] = [
  ...
  entry('reports', 'score-gauge', 'ScoreGauge', 'components/report/ScoreGauge.tsx', ['variants', 'interactive']),
  entry('settings', 'credential-input', 'CredentialInput', 'components/security/CredentialInput.tsx', ['interactive', 'states']),
  ...
  entry('signals', 'decision-signal-context-chip', 'DecisionSignalContextChip', 'components/decision-signals/DecisionSignalContextChip.tsx'),
  entry('signals', 'decision-signal-details', 'DecisionSignalDetails', 'components/decision-signals/DecisionSignalDetails.tsx', ['default', 'loading', 'empty', 'error']),
  ...
  entry('signals', 'portfolio-signal-summary', 'PortfolioSignalSummary', 'components/decision-signals/PortfolioSignalSummary.tsx', ['default', 'loading', 'empty']),
  ...
  entry('watchlist', 'field-trust-panel', 'FieldTrustPanel', 'components/stocks/FieldTrustPanel.tsx', ['default', 'empty', 'error']),
