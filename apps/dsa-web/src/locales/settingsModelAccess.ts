...
const zh = {
  ...
  savedApiKeyHint: '出于安全，已保存的密钥不会回显。',
...
const editorZh = {
  ...
  hubLocalModels: '已注册模型：{count}',
  hubLocalManage: '管理本地模型 →',
  hubCliBackend: '后端：{backend}',
  hubCliType: '类型：{type}',
  hubCliHealth: '健康：{health}',
  hubCliManage: '管理生成后端 →',
  hubCliLocal: '本地 CLI',
  hubCliApi: '云端 API 后端',
  ...
  hubEnableBlockedByFailedTest: '连接测试失败，无法启用。请先修复后再测试。',
...
const editorEn: Record<keyof typeof editorZh, string> = {
  ...
  hubLocalModels: 'Registered models: {count}',
  hubLocalManage: 'Manage local models →',
  hubCliBackend: 'Backend: {backend}',
  hubCliType: 'Type: {type}',
  hubCliHealth: 'Health: {health}',
  hubCliManage: 'Manage generation backend →',
  hubCliLocal: 'Local CLI',
  hubCliApi: 'Cloud API backend',
  ...
  hubEnableBlockedByFailedTest: 'Connection test failed. Fix the source and retest before enabling.',
