...
const editorZh = {
  ...
  retry: '重试',
  hubSearchLabel: '筛选云端模型连接',
  hubSearchPlaceholder: '按名称、服务商或模型筛选',
  hubCloudGroup: '云端 / API 连接',
  hubLocalGroup: '本地模型运行时',
  hubCliGroup: '本机 CLI 运行时',
  hubNoSearchMatches: '没有匹配的云端模型连接。',
  hubStatusAvailable: '可用',
  hubStatusUnavailable: '不可用',
  hubStatusNotConfigured: '未配置',
  hubStatusFailed: '检测失败',
  hubStatusLoading: '检测中',
  hubStatusStarting: '启动中',
  hubLocalLoading: '正在检测本地模型运行时…',
  hubLocalFailed: '本地模型运行时检测失败。',
  hubLocalFailedReason: '失败原因：{reason}',
  hubLocalStatus: '运行时状态：{status}',
  hubLocalConfigured: '已配置本地模型',
  hubLocalNone: '尚未注册本地模型。可在「本地模型」页下载或导入。',
  hubLocalPrimary: '主用：{model}',
  hubLocalAgent: 'Agent：{model}',
  hubLocalCheckedAt: '最近检测：{time}',
  hubLocalRecheck: '重新检测本地运行时',
  hubCliLoading: '正在检测本机 CLI…',
  hubCliFailed: '本机 CLI 检测失败。',
  hubCliFailedReason: '失败原因：{reason}',
  hubCliActive: '当前 CLI：{backend}',
  hubCliFallback: '回退 CLI：{backend}',
  hubCliNone: '未配置本机 CLI（当前为云端路径）。',
  hubCliCheckedAt: '最近检测：{time}',
  hubCliRecheck: '重新检测本机 CLI',
  hubActiveHeader: '当前生效',
  hubPrimaryModel: '主分析：{model}',
  hubAgentModel: 'Agent：{model}',
  hubVisionModel: '视觉：{model}',
  hubNoPrimary: '尚未分配主分析模型',
  hubLocalManage: '管理本地模型 →',
  hubCliManage: '管理生成后端 →',
  hubTypePickerTitle: '添加模型来源',
  hubTypePickerDescription: '云端 API、本地模型服务与本地 CLI 同属模型分类。',
  hubTypeCloud: '云端 / API',
  hubTypeCloudDescription: 'Gemini、OpenAI、兼容网关等',
  hubTypeLocal: '本地模型服务',
  hubTypeLocalDescription: 'Ollama 与本地 OpenAI 兼容服务',
  hubTypeCli: '本地 CLI 运行时',
  hubTypeCliDescription: 'Codex / Claude Code / OpenCode 等',
  hubAutoDisabledTitle: '测试失败的来源已停用',
  hubAutoDisabledMessage: '以下来源测试失败，已自动停用且不会显示为可用：{sources}。修复后请重新测试并启用。',
  hubAutoDisabledDismiss: '知道了',
...
const editorEn: Record<keyof typeof editorZh, string> = {
  ...
  retry: 'Retry',
  hubSearchLabel: 'Filter cloud model connections',
  hubSearchPlaceholder: 'Filter by name, provider, or model',
  hubCloudGroup: 'Cloud / API connections',
  hubLocalGroup: 'Local model runtime',
  hubCliGroup: 'Local CLI runtime',
  hubNoSearchMatches: 'No cloud model connections match this filter.',
  hubStatusAvailable: 'Available',
  hubStatusUnavailable: 'Unavailable',
  hubStatusNotConfigured: 'Not configured',
  hubStatusFailed: 'Check failed',
  hubStatusLoading: 'Checking',
  hubStatusStarting: 'Starting',
  hubLocalLoading: 'Checking local model runtime…',
  hubLocalFailed: 'Local model runtime check failed.',
  hubLocalFailedReason: 'Reason: {reason}',
  hubLocalStatus: 'Runtime status: {status}',
  hubLocalConfigured: 'Local models configured',
  hubLocalNone: 'No local models registered yet. Download or import them on the Local Models view.',
  hubLocalPrimary: 'Primary: {model}',
  hubLocalAgent: 'Agent: {model}',
  hubLocalCheckedAt: 'Last checked: {time}',
  hubLocalRecheck: 'Recheck local runtime',
  hubCliLoading: 'Checking local CLI…',
  hubCliFailed: 'Local CLI check failed.',
  hubCliFailedReason: 'Reason: {reason}',
  hubCliActive: 'Active CLI: {backend}',
  hubCliFallback: 'Fallback CLI: {backend}',
  hubCliNone: 'No local CLI configured (using cloud path).',
  hubCliCheckedAt: 'Last checked: {time}',
  hubCliRecheck: 'Recheck local CLI',
  hubActiveHeader: 'Currently active',
  hubPrimaryModel: 'Main analysis: {model}',
  hubAgentModel: 'Agent: {model}',
  hubVisionModel: 'Vision: {model}',
  hubNoPrimary: 'No main analysis model assigned yet',
  hubLocalManage: 'Manage local models →',
  hubCliManage: 'Manage generation backend →',
  hubTypePickerTitle: 'Add model source',
  hubTypePickerDescription: 'Cloud API, local model servers, and local CLI runtimes share one Model category.',
  hubTypeCloud: 'Cloud / API',
  hubTypeCloudDescription: 'Gemini, OpenAI, compatible gateways, and more',
  hubTypeLocal: 'Local model server',
  hubTypeLocalDescription: 'Ollama and local OpenAI-compatible servers',
  hubTypeCli: 'Local CLI runtime',
  hubTypeCliDescription: 'Codex / Claude Code / OpenCode and similar',
  hubAutoDisabledTitle: 'Failed sources were disabled',
  hubAutoDisabledMessage: 'These sources failed connectivity tests and were disabled so they are not shown as available: {sources}. Fix them, retest, then enable again.',
  hubAutoDisabledDismiss: 'Dismiss',
