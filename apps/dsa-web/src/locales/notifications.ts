...
export const NOTIFICATIONS_TEXT = createUiLanguageRecord('locales.notifications.NOTIFICATIONS_TEXT', {
  zh: {
    ...
    paletteTitle: '快速前往',
    paletteDescription: '搜索股票、报告、策略、管线、设置、页面和操作',
    searchPlaceholder: '搜索股票、报告、策略、管线、设置、页面或操作',
    pagesGroup: '页面',
    actionsGroup: '操作',
    reportsGroup: '报告',
    skillsGroup: '策略',
    ...
    skillSearchUnavailable: '策略搜索暂时不可用',
  ...
  en: {
    ...
    paletteDescription: 'Search stocks, reports, skills, pipelines, settings, pages, and actions',
    searchPlaceholder: 'Search stocks, reports, skills, pipelines, settings, pages, or actions',
    pagesGroup: 'Pages',
    actionsGroup: 'Actions',
    reportsGroup: 'Reports',
    skillsGroup: 'Skills',
    pipelinesGroup: 'Pipelines',
    settingsGroup: 'Settings',
    searchUnavailable: 'Report search is temporarily unavailable',
    skillSearchUnavailable: 'Skill search is temporarily unavailable',
