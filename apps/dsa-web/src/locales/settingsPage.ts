...
const zh = {
  ...
  emptyValue: '（空）',
  autosaveScheduled: '等待自动保存',
  autosaveSaving: '自动保存中…',
  autosaveSaved: '已自动保存',
  autosaveFailed: '自动保存失败',
  autosaveConflicted: '保存冲突',
  autosaveRetry: '重试',
  autosaveRestore: '恢复服务器值',
  autosaveResetGroup: '重置当前分组',
  quickSetup: '快速配置',
  ...
  diagnostics: '开发者诊断',
  modelAccess: '模型来源',
  modelAccessDescription: '统一管理云端 API、本地模型服务与本地 CLI：添加来源 → 测试 → 启用模型 → 分配到任务。',
  connectionSchemaUnavailable: '连接 Schema 不完整或不可用',
  returnTaskRouting: '返回任务路由',
  addModelService: '＋ 添加模型来源',
  eventMonitor: '事件监控',
...
const en: Record<keyof typeof zh, string> = {
  ...
  emptyValue: '(empty)',
  autosaveScheduled: 'Autosave scheduled',
  autosaveSaving: 'Autosaving…',
  autosaveSaved: 'Autosaved',
  autosaveFailed: 'Autosave failed',
  autosaveConflicted: 'Save conflict',
  autosaveRetry: 'Retry',
  autosaveRestore: 'Restore server values',
  autosaveResetGroup: 'Reset current group',
  ...
  goModelAccess: 'Go to model sources',
  ...
  modelAccess: 'Model sources',
  modelAccessDescription: 'Manage cloud APIs, local model servers, and local CLI runtimes in one place: add source → test → enable models → assign to tasks.',
  connectionSchemaUnavailable: 'Connection Schema is incomplete or unavailable',
  returnTaskRouting: 'Return to task routing',
  addModelService: '+ Add model source',
