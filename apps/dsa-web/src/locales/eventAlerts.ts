...
const EVENT_ALERT_PAGE_TEXT_BASE = {
  zh: {
    ...
    suggestedAction: '建议动作', autoAnalysisStatus: '自动分析', openAnalysis: '打开分析', openStock: '打开个股', degradedNote: '上下文部分降级（托管数据不完整）', matchedCount: '匹配条目：{count}', triggeredAt: '触发时间',
    status: '状态', gradeMajor: '重大', gradeRoutine: '常规', gradeUnclassified: '未评估', noWhyProvided: '后端未提供「为何重要」说明。',
  ...
  en: {
    ...
    suggestedAction: 'Suggested action', autoAnalysisStatus: 'Auto analysis', openAnalysis: 'Open analysis', openStock: 'Open stock', degradedNote: 'Partial context (managed data incomplete)', matchedCount: 'Matched items: {count}', triggeredAt: 'Triggered at',
    status: 'Status', gradeMajor: 'Major', gradeRoutine: 'Routine', gradeUnclassified: 'Not evaluated', noWhyProvided: 'Backend did not provide a why-it-matters explanation.',
