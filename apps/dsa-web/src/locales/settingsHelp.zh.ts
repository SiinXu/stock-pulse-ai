...
const settingsHelpZhCN: SettingsHelpMap = {
  ...
  'settings.system.daily_brief': {
    title: '每日简报',
    summary: '按计划生成个人晨报：持仓、隔夜要点、财报前瞻、昨日分析、自选与历史准确率复盘。',
    ...
    impact: ['影响计划简报生成、推送与历史。'],
    notes: ['定时投递需要 schedule 模式。'],
  },
  'settings.system.event_research_brief': {
    title: '事件研究简报',
    summary: '可选的独立财报类事件研究简报：关注指标、超预期定义与事后核对清单。',
    usage: 'EVENT_RESEARCH_BRIEF_ENABLED 打开独立调度；NOTIFY/PERSIST_HISTORY/SAVE_REPORT_FILE 控制投递；LOOKBACK_HOURS 与 CATEGORIES 限定扫描（首日 earnings）。每日晨报也会嵌入前瞻。',
    valueNotes: ['默认关闭。', '仅托管公司事件触发。', '不编造一致预期。'],
    impact: ['影响事件前瞻通知与可选历史。'],
