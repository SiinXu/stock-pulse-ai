 ...
 *
 * Runtime service worker logic is generated by `vite-plugin-shell-pwa.ts` and
 * must stay aligned with these path rules (unit tests cover this module; the
 * emitted sw.js mirrors the same never-cache / shell-static path checks).
 */
