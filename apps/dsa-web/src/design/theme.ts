 ...
 *    `--home-action-*` and `--home-prose-*` collapsed to Layer 1 plus
 *    use-site alpha; leftover title-accent collapsed to Layer 1
 *    `--foreground` with no alpha. Keep the prefix ban. Collapse remaining
 *    leftover `--home-*` in T25/T40.
