...
/** Shared locale copy for decision-signal navigation and calibration. */
export const DECISION_SIGNAL_CALIBRATION_TRANSLATIONS = {
  ...
  fr: {
    "i18n.uiText.UI_TEXT.decisionSignals.tab.feed": "Signaux",
    "i18n.uiText.UI_TEXT.decisionSignals.tab.history": "Historique",
    "i18n.uiText.UI_TEXT.decisionSignals.tab.review": "Bilan",
