...
>;
type PortfolioImportKey = FutuImportKey | 'locales.portfolio.PORTFOLIO_TEXT.openImport';
...
export const PORTFOLIO_FUTU_IMPORT_TRANSLATIONS_EAST = {
  ja: {
...
} satisfies Record<string, Record<PortfolioImportKey, string>>;
