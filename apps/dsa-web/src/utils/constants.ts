...
// Default to keep same-origin API, avoiding sending erroneous requests to user's localhost during production/static deployments.
// Overrides default behavior only when VITE_API_URL is explicitly provided.
