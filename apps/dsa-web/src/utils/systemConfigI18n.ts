...
const fieldDescriptionMap: Record<string, string> = {
  ...
  HIGH_DISAGREEMENT_ALERTS_ENABLED: '默认开启。当多智能体分析已带有结构化 disagreement_handling 且分歧超阈值时，经 NOTIFICATION_ALERT_CHANNELS 发送专用告警；不重新计算分歧，单渠道失败不中断分析。',
  HIGH_DISAGREEMENT_THRESHOLD: '高分歧告警分数阈值（0-1，默认 0.6）。与 disagreement_handling.disagreement_score 比较；high_disagreement=true 也会触发。',
