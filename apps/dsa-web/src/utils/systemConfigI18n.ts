...
const fieldTitleMapZh = {
  ...
  CRYPTO_PROVIDER_ENABLED: '启用 CoinGecko 加密资产数据源',
  COINGECKO_API_KEY: 'CoinGecko API Key',
  COINGECKO_API_PLAN: 'CoinGecko API 套餐',
  COINGECKO_API_BASE: 'CoinGecko API 地址',
  CRYPTO_COINGECKO_PRIORITY: 'CoinGecko 数据源优先级',
...
const fieldTitleMapEn = {
  ...
  CRYPTO_PROVIDER_ENABLED: 'CoinGecko Crypto Provider',
  COINGECKO_API_KEY: 'CoinGecko API Key',
  COINGECKO_API_PLAN: 'CoinGecko API Plan',
  COINGECKO_API_BASE: 'CoinGecko API Base',
  CRYPTO_COINGECKO_PRIORITY: 'CoinGecko Provider Priority',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  CRYPTO_PROVIDER_ENABLED: '启用显式 crypto: 命名空间的 CoinGecko 数据源；配置变更需重启。',
  COINGECKO_API_KEY: '可选 Demo/Pro 凭据；不会发送到自定义域名。',
  COINGECKO_API_PLAN: '选择 keyless、demo 或 pro，以绑定正确官方域名和鉴权请求头。',
  COINGECKO_API_BASE: '仅 keyless 模式可使用的自定义 HTTPS 地址。',
  CRYPTO_COINGECKO_PRIORITY: '控制 CoinGecko 在加密资产数据源中的尝试顺序。',
