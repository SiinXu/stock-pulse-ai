...
const fieldTitleMapEn = {
  ...
  TASK_ROUTING_PIN_REPORT: 'Report Task Model Pin',
  TASK_ROUTING_PIN_AGENT: 'Agent Task Model Pin',
  TASK_ROUTING_PIN_VISION: 'Vision Task Model Pin',
  TASK_ROUTING_PIN_MARKET_REVIEW: 'Market Review Task Model Pin',
  TASK_ROUTING_PIN_CHEAP_SCAN: 'Cheap Scan Task Model Pin',
  TASK_ROUTING_PIN_DEEP_REASONING: 'Deep Reasoning Task Model Pin',
  TASK_ROUTING_PIN_CODING: 'Coding Task Model Pin',
