...
const fieldTitleMapEn = {
  ...
  TASK_ROUTING_PIN_REPORT: 'Task Routing Pin (Report)',
  TASK_ROUTING_PIN_AGENT: 'Task Routing Pin (Agent)',
  TASK_ROUTING_PIN_VISION: 'Task Routing Pin (Vision)',
  TASK_ROUTING_PIN_MARKET_REVIEW: 'Task Routing Pin (Market Review)',
  TASK_ROUTING_PIN_CHEAP_SCAN: 'Task Routing Pin (Cheap Scan)',
  TASK_ROUTING_PIN_DEEP_REASONING: 'Task Routing Pin (Deep Reasoning)',
  TASK_ROUTING_PIN_CODING: 'Task Routing Pin (Coding)',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  TASK_ROUTING_PIN_REPORT: '报告任务模型固定选择，设置后覆盖自动路由。',
  TASK_ROUTING_PIN_AGENT: 'Agent 任务模型固定选择，设置后覆盖自动路由。',
  TASK_ROUTING_PIN_VISION: '视觉任务模型固定选择，设置后覆盖自动路由。',
  TASK_ROUTING_PIN_MARKET_REVIEW: '市场复盘任务模型固定选择。',
  TASK_ROUTING_PIN_CHEAP_SCAN: '廉价扫描任务模型固定选择。',
  TASK_ROUTING_PIN_DEEP_REASONING: '深度推理任务模型固定选择。',
  TASK_ROUTING_PIN_CODING: '编码任务模型固定选择。',
