...
const fieldTitleMapZh = {
  ...
  AGENT_STEP_CRITIQUE_ENABLED: '即时步骤批评',
  AGENT_REFLECTION_ENABLED: '轨迹反思',
  AGENT_REFLECTION_LLM_BUDGET: '轨迹反思 LLM 预算',
  AGENT_META_REVIEW_ENABLED: '跨运行元审查',
  AGENT_META_REVIEW_MIN_EPISODES: '元审查样本阈值',
