...
const fieldTitleMapZh = {
  ...
  REASONING_TRACE_EXPORT_ENABLED: '启用推理轨迹导出',
  REASONING_TRACE_EXPORT_MAX_CHARS: '推理轨迹导出最大字符数',
...
const fieldTitleMapEn = {
  ...
  REASONING_TRACE_EXPORT_ENABLED: 'Reasoning Trace Export Enabled',
  REASONING_TRACE_EXPORT_MAX_CHARS: 'Reasoning Trace Export Max Chars',
