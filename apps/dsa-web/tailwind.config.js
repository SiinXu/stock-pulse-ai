  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'primary-gradient': 'linear-gradient(135deg, hsl(var(--foreground)) 0%, hsl(var(--foreground) / 0.9) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 0 0 1px hsl(var(--primary) / 0.14)',
        'glow-purple': '0 0 0 1px hsl(var(--color-purple) / 0.14)',
        'glow-success': '0 0 0 1px hsl(var(--success) / 0.16)',
        'glow-danger': '0 0 0 1px hsl(var(--destructive) / 0.16)',
        'cyan/20': '0 12px 28px hsl(0 0% 0% / 0.14)',
        'cyan/22': '0 18px 34px hsl(0 0% 0% / 0.18)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 0 1px hsl(var(--primary) / 0.12)' },
          '50%': { boxShadow: '0 0 0 1px hsl(var(--primary) / 0.24)' },
        },
      },
    },
  },
